...
use_ok 'DBIx::Class2::Optional::Dependencies';
...
my $sqlt_dep = DBIx::Class2::Optional::Dependencies->req_list_for ('deploy');
is_deeply (
  [ keys %$sqlt_dep ],
  [ 'SQL::Translator' ],
...
# make module loading impossible, regardless of actual libpath contents
{
  ...
  ok (
    ! DBIx::Class2::Optional::Dependencies->req_ok_for ('deploy'),
    'deploy() deps missing',
  );

  like (
    DBIx::Class2::Optional::Dependencies->req_missing_for ('deploy'),
    qr/^SQL::Translator \>\= \d/,
    'expected missing string contents',
  );

  like (
    DBIx::Class2::Optional::Dependencies->req_errorlist_for ('deploy')->{'SQL::Translator'},
...
#reset cache
%DBIx::Class2::Optional::Dependencies::req_availability_cache = ();
...
is_deeply (
  DBIx::Class2::Optional::Dependencies->req_errorlist_for ('deploy'),
  {},
...
for (1..2) {
  throws_ok {
    DBIx::Class2::Optional::Dependencies->req_list_for();
  ...
  throws_ok {
    DBIx::Class2::Optional::Dependencies->req_list_for('invalid_groupname');
  } qr/Requirement group 'invalid_groupname' does not exist/,
  "req_list_for with invalid groupname throws exception on run $_";
}

is_deeply(
  DBIx::Class2::Optional::Dependencies->req_list_for('rdbms_pg'),
  {
    'DBD::Pg' => '0',
  }, 'optional dependencies for deploying to Postgres ok');

is_deeply(
  DBIx::Class2::Optional::Dependencies->req_list_for('test_rdbms_pg'),
  {
    'DBD::Pg'        => '2.009002',
  }, 'optional dependencies for testing Postgres with ENV var ok');

is_deeply(
  DBIx::Class2::Optional::Dependencies->req_list_for('test_rdbms_oracle'),
