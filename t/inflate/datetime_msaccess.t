...
plan skip_all => 'Test needs ' .
  (join ' and ', map { $_ ? $_ : () }
    ...
    (join ' or ', map { $_ ? $_ : () }
      DBIx::Class2::Optional::Dependencies->req_missing_for('test_rdbms_msaccess_odbc'),
      DBIx::Class2::Optional::Dependencies->req_missing_for('test_rdbms_msaccess_ado')))
  unless
    DBIx::Class2::Optional::Dependencies->req_ok_for ('test_dt') && (
    $dsn && DBIx::Class2::Optional::Dependencies->req_ok_for('test_rdbms_msaccess_odbc')
    or
    $dsn2 && DBIx::Class2::Optional::Dependencies->req_ok_for('test_rdbms_msaccess_ado'))
      or (not $dsn || $dsn2);
