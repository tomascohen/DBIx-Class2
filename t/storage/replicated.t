...
BEGIN {
    require DBIx::Class2;
    plan skip_all => 'Test needs ' . DBIx::Class2::Optional::Dependencies->req_missing_for ('test_replicated')
      unless DBIx::Class2::Optional::Dependencies->req_ok_for ('test_replicated');
...
use DBIx::Class2::Storage::DBI::Replicated;
{
...
TESTSCHEMACLASSES: {
    ...
    package DBIx::Class2::DBI::Replicated::TestReplication;
    ...
    package DBIx::Class2::DBI::Replicated::TestReplication::SQLite;

    use DBICTest;
    use File::Copy;
    use base 'DBIx::Class2::DBI::Replicated::TestReplication';
    ...
    package DBIx::Class2::DBI::Replicated::TestReplication::Custom;
    use base 'DBIx::Class2::DBI::Replicated::TestReplication';
...
my $replicated_class = DBICTest->has_custom_dsn ?
    'DBIx::Class2::DBI::Replicated::TestReplication::Custom' :
    'DBIx::Class2::DBI::Replicated::TestReplication::SQLite';
...
for my $method (qw/by_connect_info by_storage_type/) {
  ...
  isa_ok $replicated->schema->storage
      => 'DBIx::Class2::Storage::DBI::Replicated';

  isa_ok $replicated->schema->storage->balancer
      => 'DBIx::Class2::Storage::DBI::Replicated::Balancer::Random'
...
### check that all Storage::DBI methods are handled by ::Replicated
{
  my @storage_dbi_methods = Class::MOP::Class
    ->initialize('DBIx::Class2::Storage::DBI')->get_all_method_names;

  my @replicated_methods  = DBIx::Class2::Storage::DBI::Replicated->meta
...
# remove DBIx::Class2 (the root parent, with CAG and stuff) methods
  my @root_methods = Class::MOP::Class->initialize('DBIx::Class2')
    ->get_all_method_names;
  my %count;
...
# check that what's left is implemented
  ...
  if ((grep $count{$_} == 2, @storage_dbi_methods) == @storage_dbi_methods) {
    pass 'all DBIx::Class2::Storage::DBI methods implemented';
  }
  else {
    my @unimplemented = grep $count{$_} == 1, @storage_dbi_methods;

    fail 'the following DBIx::Class2::Storage::DBI methods are unimplemented: '
      . "@unimplemented";
  }
}
...
isa_ok $replicated->schema->storage->pool
    => 'DBIx::Class2::Storage::DBI::Replicated::Pool';

does_ok $replicated->schema->storage->balancer
    => 'DBIx::Class2::Storage::DBI::Replicated::Balancer';
...
is ((grep $_->isa('DBIx::Class2::Storage::DBI'), @all_storages),
    3
...
does_ok $replicated_storages[0]
    => 'DBIx::Class2::Storage::DBI::Replicated::Replicant';
...
## Check that master_read_weight is honored
{
    ...
    local
    *DBIx::Class2::Storage::DBI::Replicated::Balancer::Random::_random_number =
    sub { 999 };
