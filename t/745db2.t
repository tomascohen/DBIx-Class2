...
plan skip_all => 'Test needs ' . DBIx::Class2::Optional::Dependencies->req_missing_for ('test_rdbms_db2')
  unless DBIx::Class2::Optional::Dependencies->req_ok_for ('test_rdbms_db2');
