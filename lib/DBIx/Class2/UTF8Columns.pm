package DBIx::Class2::UTF8Columns;
use strict;
use warnings;
...
DBIx::Class2::UTF8Columns - Force UTF8 (Unicode) flag on columns (DEPRECATED)
...
stored and de-serialised to unicode strings on retrieval.
  ...
  THE USE OF THIS MODULE (AND ITS COUSIN DBIx::Class2::ForceUTF8) IS VERY
...
Recently (April 2010) a bug was found deep in the core of L<DBIx::Class2>
which affects any component attempting to perform encoding/decoding by
overloading L<store_column|DBIx::Class2::Row/store_column> and
L<get_columns|DBIx::Class2::Row/get_columns>. As a result of this problem
L<create|DBIx::Class2::ResultSet/create> sends the original column values
to the database, while L<update|DBIx::Class2::ResultSet/update> sends the
encoded values. L<DBIx::Class2::UTF8Columns> and L<DBIx::Class2::ForceUTF8>
...
implications of changing such a fundamental behavior of DBIx::Class2 are
...
L<join us on IRC or the mailing list|DBIx::Class2/GETTING HELP/SUPPORT>
...
Note that this module overloads L<DBIx::Class2::Row/store_column> in a way
that may prevent other components overloading the same method from working
correctly. This component must be the last one before L<DBIx::Class2::Row>
(which is provided by L<DBIx::Class2::Core>). DBIx::Class2 will detect such
incorrect component order and issue an appropriate warning, advising which
components need to be loaded differently.

=head1 SEE ALSO

L<Template::Stash::ForceUTF8>, L<DBIx::Class2::UUIDColumns>.
