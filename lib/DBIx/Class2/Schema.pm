...
use DBIx::Class2::_Util qw(refcount quote_sub is_exception scope_guard);
...
DBIx::Class2::Schema - composable schemas
...
use L<DBIx::Class2> and allows you to use more than one concurrent connection
with your classes.

NB: If you're used to L<Class::DBI> it's worth reading the L</SYNOPSIS>
carefully, as DBIx::Class2 does things a little differently. Note in
...
using L<resultset_class|DBIx::Class2::ResultSource/resultset_class> to some
...
sub load_namespaces {
  ...
  my @to_register;
  {
    ...
    local *Class::C3::reinitialize = sub { } if DBIx::Class2::_ENV_::OLD_MRO;
    ...
    foreach my $source_name (@source_names_by_subclass_last) {
      ...
      if($preset_resultset_class && $preset_resultset_class ne 'DBIx::Class2::ResultSet') {
      ...
      # DBIx::Class2::Resultset and there is nothing to check
      elsif($found_resultset_class ||= $default_resultset_class) {
        $class->ensure_class_loaded($found_resultset_class);
        if(!$found_resultset_class->isa("DBIx::Class2::ResultSet")) {
            carp "load_namespaces found ResultSet class '$found_resultset_class' that does not subclass DBIx::Class2::ResultSet";
        }
...
=item Default value: DBIx::Class2::Storage::DBI

=back

Set the storage class that will be instantiated when L</connect> is called.
If the classname starts with C<::>, the prefix C<DBIx::Class2::Storage> is
assumed by L</connect>.

You want to use this to set subclasses of L<DBIx::Class2::Storage::DBI>
...
L<DBIx::Class2::Storage::DBI::Replicated> for an example of this.
...
L<DBIx::Class2::Exception/throw>, with the exception message passed as the only
argument.
...
L<DBIx::Class2::Manual::Cookbook/Adding Indexes And Functions To Your SQL>.
...
and use L<dbh_do|DBIx::Class2::Storage::DBI/dbh_do>.
...
See L<DBIx::Class2::Storage::DBI/"connect_info"> for DBI-specific
syntax on the C<@connectinfo> argument, or L<DBIx::Class2::Storage> in
general.
...
=item Arguments: L<$source_name|DBIx::Class2::ResultSource/source_name>

=item Return Value: L<$resultset|DBIx::Class2::ResultSet>

=back

  my $rs = $schema->resultset('DVD');

Returns the L<DBIx::Class2::ResultSet> object for the registered source
name.
...
=item Return Value: L<@source_names|DBIx::Class2::ResultSource/source_name>
...
Returns the L<DBIx::Class2::ResultSource> object for the registered
source name.
...
See L<DBIx::Class2::Storage/"txn_do"> for more information.
...
L<DBIx::Class2::Storage/txn_scope_guard>.
...
L<DBIx::Class2::Storage/"txn_begin"> for more information.
...
$schema->storage->txn_commit. See L<DBIx::Class2::Storage/"txn_commit">
...
L<DBIx::Class2::Storage/"txn_rollback"> for more information.
...
Returns the L<DBIx::Class2::Storage> object for this Schema. Grab this
...
found in L<DBIx::Class2::Storage::DBI>.

=head2 populate

=over 4

=item Arguments: L<$source_name|DBIx::Class2::ResultSource/source_name>, [ \@column_list, \@row_values+ ] | [ \%col_data+ ]
...
A convenience shortcut to L<DBIx::Class2::ResultSet/populate>. Equivalent to:
...
sub connection {
  ...
  $storage_class =~ s/^::/DBIx::Class2::Storage::/;
...
For each L<DBIx::Class2::ResultSource> in the schema, this method creates a
...
It also attaches a corresponding L<DBIx::Class2::ResultSource> object to the
...
sub setup_connection_class {
  ...
  $class->inject_base($target => 'DBIx::Class2::DB');
...
L<DBIx::Class2::Storage/"svp_begin"> for more information.
...
L<DBIx::Class2::Storage/"svp_release"> for more information.
...
L<DBIx::Class2::Storage/"svp_rollback"> for more information.
...
Throws an exception. Obeys the exemption rules of L<DBIx::Class2::Carp> to report
...
is nothing safe DBIx::Class2 can do, aside from displaying this error. A future
...
This guard was activated beginning"
    ...
    eval {
      ...
      if( $act->(@args) ) {
        ...
        .' result in an exception. DBIx::Class2 is unable to function without a reliable'
  ...
  DBIx::Class2::Exception->throw($args[0], $self->stacktrace);
}
...
Additionally, the DBIx::Class2 parser accepts a C<sources> parameter as a hash
...
=item Arguments: See L<DBIx::Class2::Storage::DBI/deployment_statements>
...
=item Arguments: See L<DBIx::Class2::Storage::DBI/create_ddl_dir>
...
format.
 ...
 Prior to DBIx::Class2 version 0.08100 this method had a different signature:
 ...
 in any overriding methods:
    ...
    ($dir, $version) = ($version, $dir) if ($DBIx::Class2::VERSION < 0.08100);
...
sub thaw {
  my ($self, $obj) = @_;
  local $DBIx::Class2::ResultSourceHandle::thaw_schema = $self;
...
Recommended way of dcloning L<DBIx::Class2::Row> and L<DBIx::Class2::ResultSet>
...
Registers a class which isa DBIx::Class2::ResultSourceProxy. Equivalent to
calling:
...
=item Arguments: $source_name, L<$result_source|DBIx::Class2::ResultSource>

=back

This method is called by L</register_class>.

Registers the L<DBIx::Class2::ResultSource> in the schema with the given
source name.
...
Removes the L<DBIx::Class2::ResultSource> from the schema for the given source name.
...
Calls L<DBIx::Class2::Schema/"compose_namespace"> to the target namespace,
calls L<DBIx::Class2::Schema/connection> with @db_info on the new schema,
...
L<DBIx::Class2::Schema/connect> and use the resulting schema object to operate
on L<DBIx::Class2::ResultSet> objects with L<DBIx::Class2::Schema/resultset> for
more information.
...
sub compose_connection {
  ...
  my $base = 'DBIx::Class2::ResultSetProxy';
  try {
    eval "require ${base};"
  }
  catch {
