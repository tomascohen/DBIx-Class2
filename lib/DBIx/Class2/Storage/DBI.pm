package DBIx::Class2::Storage::DBI;
# -*- mode: cperl; cperl-indent-level: 2 -*-

use strict;
use warnings;

use base qw/DBIx::Class2::Storage::DBIHacks DBIx::Class2::Storage/;
use mro 'c3';
...
use DBIx::Class2::_Util qw(quote_sub perlstring serialize detected_reinvoked_destructor sigwarn_silencer);
use namespace::clean;

# default cursor class, overridable in connect_info attributes
__PACKAGE__->cursor_class('DBIx::Class2::Storage::DBI::Cursor');
...
__PACKAGE__->sql_maker_class('DBIx::Class2::SQLMaker');
...
for my $meth (keys %$storage_accessor_idx, qw(
  ...
  quote_sub
    ...
    if (
      ...
      goto $_[0]->can(%2$s) unless DBIx::Class2::_ENV_::BROKEN_GOTO;
...
DBIx::Class2::Storage::DBI - DBI storage handler
...
L<DBIx::Class2::Storage> for general information.  This pod only
...
sub DESTROY {
  ...
  $_[0]->_verify_pid unless DBIx::Class2::_ENV_::BROKEN_FORK;
...
This method is normally called by L<DBIx::Class2::Schema/connection>, which
...
L<extra attributes|/DBIx::Class2 specific connection attributes>
recognized by DBIx::Class2:
...
L<extra attributes|/DBIx::Class2 specific connection attributes> recognized
by DBIx::Class2:
...
set C<AutoCommit> to either I<0> or I<1>.  L<DBIx::Class2> further
recommends that it be set to I<1>, and that you perform transactions
via our L<DBIx::Class2::Schema/txn_do> method.  L<DBIx::Class2> will set it
to I<1> if you do not do explicitly set it to zero.  This is the default
for most DBDs. See L</DBIx::Class2 and AutoCommit> for details.

=head3 DBIx::Class2 specific connection attributes

In addition to the standard L<DBI|DBI/ATTRIBUTES COMMON TO ALL HANDLES>
L<connection|DBI/Database Handle Attributes> attributes, DBIx::Class2 recognizes
...
L<DBIx::Class2::InflateColumn::DateTime>.
...
of available limit dialects see L<DBIx::Class2::SQLMaker::LimitDialects>.
...
If this option is true, L<DBIx::Class2> will use savepoints when nesting
...
L<DBIx::Class2::Storage::DBI::Cursor>.

=back

Some real-life examples of arguments to L</connect_info> and
L<DBIx::Class2::Schema/connect>
  ...
  # Subref + DBIx::Class2-specific connection options
  ->connect_info(
    [
      sub { DBI->connect(...) },
      {
...
sub connect_info {
  ...
  if (keys %attrs and ref $args[0] ne 'CODE') {
    carp_unique (
      ...
      . 'DBIx::Class2::Storage::DBI for more info). If you still want to '
...
sub dbh_do {
  ...
  DBIx::Class2::Storage::BlockRunner->new(
    storage => $self,
    wrap_txn => 0,
    retry_handler => sub {
...
sub _populate_dbh {
  ...
  $_[0]->_conn_pid($$) unless DBIx::Class2::_ENV_::BROKEN_FORK; # on win32 these are in fact threads
...
sub _determine_driver {
  ...
  if ((not $self->_driver_determined) && (not $self->{_in_determine_driver})) {
    ...
    if (ref($self) eq __PACKAGE__) {
      ...
      if ($driver) {
        my $storage_class = "DBIx::Class2::Storage::DBI::${driver}";
...
sub _determine_connector_driver {
  ...
  my $subclass = "DBIx::Class2::Storage::DBI::${conn}::${dbtype}";
...
L<connection option|/DBIx::Class2 specific connection attributes>
...
class B<MUST> inherit from L<DBIx::Class2::SQLMaker::ClassicExtensions> and
L<SQL::Abstract::Classic> as shown below.

This infrastructure is provided to aid recent activity around experimental new
aproaches to SQL generation within DBIx::Class2. You can (and are encouraged to)
mix and match old and new within the same codebase as follows:

  package DBIx::Class2::Awesomer::SQLMaker;
  ...
  my $experimental_schema = $original_schema->connect(
    ...
    },
    {
      ...
      # https://metacpan.org/pod/DBIx::Class2::Storage::DBI#on_connect_call
      on_connect_call => [ [ rebase_sqlmaker => 'DBIx::Class2::Awesomer::SQLMaker' ] ],
    },
  );
  ...
  my $dbh_error_handler_installer = sub {
    ...
    $_[1]->{HandleError} = bless sub {
      if ($weak_self) {
        ...
        # the scope of DBIC
        DBIx::Class2::Exception->throw("DBI Exception (unhandled by DBIC, ::Schema GCed): $_[0]");
      }
      ...
      unless ($dbh->{RaiseError}) {
        carp( ref $info->[0] eq 'CODE'
          ...
          ? "The 'RaiseError' of the externally supplied DBI handle is set to false. "
           ."DBIx::Class2 will toggle it back to true, unless the 'unsafe' connect "
...
sub _gen_sql_bind {
  ...
  if (
    ...
    carp_unique 'DateTime objects passed to search() are not supported '
      ...
      . 'DBIx::Class2::Manual::FAQ. To disable this warning for good '
...
sub insert {
  ...
  if (my $retlist = $sqla_opts->{returning}) {  # if IR is supported - we will get everything in one set
    ...
    if (%retrieve_cols) {
      ...
      my $cur = DBIx::Class2::ResultSet->new($source, {
...
to L<DBIx::Class2::Schema/connect>. For a list of available limit dialects
see L<DBIx::Class2::SQLMaker::LimitDialects>.
...
currently only used by L<::AutoCast|DBIx::Class2::Storage::DBI::AutoCast> and
L<::Sybase::ASE|DBIx::Class2::Storage::DBI::Sybase::ASE>.
...
L<DBIx::Class2::Row/set_column> decides whether to mark the column as
...
sub create_ddl_dir {
  ...
  unless (DBIx::Class2::Optional::Dependencies->req_ok_for ('deploy')) {
    $self->throw_exception("Can't create a ddl file without " . DBIx::Class2::Optional::Dependencies->req_missing_for ('deploy') );
  }

  my $sqlt = SQL::Translator->new( $sqltargs );

  $sqlt->parser('SQL::Translator::Parser::DBIx::Class2');
...
Returns the statements used by L<DBIx::Class2::Storage/deploy>
and L<DBIx::Class2::Schema/deploy>.
...
from L<DBIx::Class2::Schema/ddl_filename>, the schema name and the C<$version>.
...
sub deployment_statements {
  ...
  unless (DBIx::Class2::Optional::Dependencies->req_ok_for ('deploy') ) {
    $self->throw_exception("Can't deploy without a ddl_dir or " . DBIx::Class2::Optional::Dependencies->req_missing_for ('deploy') );
  }
  ...
  my $tr = SQL::Translator->new(
    ...
    %$sqltargs,
    parser => 'SQL::Translator::Parser::DBIx::Class2',
    data => $schema,
  );
...
A boolean that reports if a particular L<DBIx::Class2::Storage::DBI> is set to
...
L<DBIx::Class2> uses L<DBIx::Class2::Relationship> names as table aliases in
queries.

This hook is to allow specific L<DBIx::Class2::Storage> drivers to change the
...
=head2 DBIx::Class2 and AutoCommit

DBIx::Class2 can do some wonderful magic with handling exceptions,
disconnections, and transactions when you use C<< AutoCommit => 1 >>
(the default) combined with L<txn_do|DBIx::Class2::Storage/txn_do> for
transaction support.
