package DBIx::Class2::Storage::Statistics;

use strict;
use warnings;

use DBIx::Class2::_Util qw(sigwarn_silencer qsub);
use IO::Handle ();
use Moo;
extends 'DBIx::Class2';
use namespace::clean;
...
DBIx::Class2::Storage::Statistics - SQL Statistics

=head1 SYNOPSIS

=head1 DESCRIPTION

This class is called by DBIx::Class2::Storage::DBI as a means of collecting
...
for collecting the statistics as discussed in L<DBIx::Class2::Manual::Cookbook>.

=head1 METHODS

=head2 new

Returns a new L<DBIx::Class2::Storage::Statistics> object.
...
L<DBIC_TRACE|DBIx::Class2::Storage/DBIC_TRACE> environment variable.
