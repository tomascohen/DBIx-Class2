...
use DBIx::Class2::_Util qw(is_exception qsub);
...
DBIx::Class2::Storage::BlockRunner - Try running a block of code until success with a configurable retry logic
...
has retry_handler => (
  ...
  isa => qsub q{
    (Scalar::Util::reftype($_[0])||'') eq 'CODE'
      or DBIx::Class2::Exception->throw('retry_handler must be a CODE reference')
  },
);
