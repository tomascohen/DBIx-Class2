package DBIx::Class2::Storage::DBI::Sybase::ASE;
...
__PACKAGE__->datetime_parser_type(
  'DBIx::Class2::Storage::DBI::Sybase::ASE::DateTime::Format'
);
...
DBIx::Class2::Storage::DBI::Sybase::ASE - Sybase ASE SQL Server support for
DBIx::Class2
...
be reblessed to L<DBIx::Class2::Storage::DBI::Sybase::ASE::NoBindVars>.
...
A recommended L<connect_info|DBIx::Class2::Storage::DBI/connect_info> setting:
...
See perldoc DBIx::Class2::Storage::DBI::Sybase::ASE for more details.
...
In L<connect_info|DBIx::Class2::Storage::DBI/connect_info> to set:
...
sub connect_call_datetime_setup {
  ...
  if ($dbh->can('syb_date_fmt')) {
    ...
    carp_once
     ...
     .'DBIx::Class2::InflateColumn::DateTime, please upgrade!';
...
As of version C<0.05000>, L<DBIx::Class2::Schema::Loader> should work well with
...
L<DBIx::Class2::Storage::DBI::Sybase::ASE::NoBindVars>.
...
the C<auto_cast> option from L<DBIx::Class2::Storage::DBI::AutoCast> is
automatically set, which you may enable on connection with
L<connect_call_set_auto_cast|DBIx::Class2::Storage::DBI::AutoCast/connect_call_set_auto_cast>.
The type info for the C<CAST>s is taken from the
L<DBIx::Class2::ResultSource/data_type> definitions in your Result classes, and
...
When using C<DBIx::Class2::Storage::DBI::Sybase::ASE::NoBindVars> transactions
...
L<ResultSet|DBIx::Class2::ResultSet> that has been executed using C<next> or
C<first> but has not been exhausted or L<reset|DBIx::Class2::ResultSet/reset>.
...
=item * use L<DBIx::Class2::Storage::DBI::Replicated>

=item * L<connect|DBIx::Class2::Schema/connect> another L<Schema|DBIx::Class2::Schema>

=item * load the data from your cursor with L<DBIx::Class2::ResultSet/all>
...
This is a bit too low for a complex L<DBIx::Class2> application, so on connection
...
for L<DBIx::Class2::InflateColumn::DateTime>.
...
L<GenericSubQ|DBIx::Class2::SQLMaker::LimitDialects/GenericSubQ>.

Fortunately, ASE and L<DBD::Sybase> support cursors properly, so when
L<GenericSubQ|DBIx::Class2::SQLMaker::LimitDialects/GenericSubQ> is too slow
you can use the L<software_limit|DBIx::Class2::ResultSet/software_limit>
L<DBIx::Class2::ResultSet> attribute to simulate limited queries by skipping
over records.
...
L<connect_info|DBIx::Class2::Storage::DBI/connect_info> is used to execute the
equivalent C<SET TEXTSIZE> command on connection.

See L</connect_call_blob_setup> for a
L<connect_info|DBIx::Class2::Storage::DBI/connect_info> setting you need to work
with C<IMAGE> columns.

=head1 BULK API

The experimental L<DBD::Sybase> Bulk API support is used for
L<populate|DBIx::Class2::ResultSet/populate> in B<void> context, in a transaction
on a separate connection.

To use this feature effectively, use a large number of rows for each
L<populate|DBIx::Class2::ResultSet/populate> call, eg.:

  while (my $rows = $data_source->get_100_rows()) {
    $rs->populate($rows);
  }

B<NOTE:> the L<add_columns|DBIx::Class2::ResultSource/add_columns>
...
L<DBIx::Class2::InflateColumn::DateTime>, and most people do, and still want to
