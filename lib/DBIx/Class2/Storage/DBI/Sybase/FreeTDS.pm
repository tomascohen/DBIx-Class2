package DBIx::Class2::Storage::DBI::Sybase::FreeTDS;

use strict;
use warnings;
use base qw/DBIx::Class2::Storage::DBI::Sybase/;
use mro 'c3';
use Try::Tiny;
use namespace::clean;
...
DBIx::Class2::Storage::DBI::Sybase::FreeTDS - Base class for drivers using
...
It is a subclass of L<DBIx::Class2::Storage::DBI::Sybase>.
...
L<connect_info|DBIx::Class2::Storage::DBI/connect_info> if omitted, lastly falls
