package DBIx::Class2::Storage::DBI::IdentityInsert;
...
DBIx::Class2::Storage::DBI::IdentityInsert - Storage Component for Sybase ASE and
MSSQL for Identity Inserts / Updates

=head1 DESCRIPTION

This is a storage component for Sybase ASE
(L<DBIx::Class2::Storage::DBI::Sybase::ASE>) and Microsoft SQL Server
(L<DBIx::Class2::Storage::DBI::MSSQL>) to support identity inserts, that is
