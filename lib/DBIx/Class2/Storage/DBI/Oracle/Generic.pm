package DBIx::Class2::Storage::DBI::Oracle::Generic;

use strict;
use warnings;
use base qw/DBIx::Class2::Storage::DBI/;
use mro 'c3';
...
__PACKAGE__->sql_maker_class('DBIx::Class2::SQLMaker::Oracle');
...
DBIx::Class2::Storage::DBI::Oracle::Generic - Oracle Support for DBIx::Class2
...
L<DBIx::Class2::Storage::DBI::Oracle::WhereJoins> is for C<(+)> joins in Oracle
versions before 9.0.
...
sub _dbh_execute {
  ...
  return DBIx::Class2::Storage::BlockRunner->new(
    storage => $self,
    wrap_txn => 0,
    retry_handler => sub {
...
In L<connect_info|DBIx::Class2::Storage::DBI/connect_info> to set the session nls
date, and timestamp values for use with L<DBIx::Class2::InflateColumn::DateTime>
...
To get more than second precision with L<DBIx::Class2::InflateColumn::DateTime>
...
### https://github.com/Perl5/DBIx-Class2/commit/5db2758de6
#
...
the L<DBIx::Class2::Relationship> name is shortened and appended with half of an
MD5 hash.

See L<DBIx::Class2::Storage::DBI/relname_to_table_alias>.
...
It uses the same syntax as L<DBIx::Class2::ResultSet/search>
...
It uses the same syntax as L<DBIx::Class2::ResultSet/order_by>
