package DBIx::Class2::Storage::DBI::ADO::MS_Jet;

use strict;
use warnings;
use base qw/
  DBIx::Class2::Storage::DBI::ADO
  DBIx::Class2::Storage::DBI::ACCESS
/;
use mro 'c3';
use DBIx::Class2::Storage::DBI::ADO::CursorUtils '_normalize_guids';
use namespace::clean;

__PACKAGE__->cursor_class('DBIx::Class2::Storage::DBI::ADO::MS_Jet::Cursor');

=head1 NAME

DBIx::Class2::Storage::DBI::ADO::MS_Jet - Support for MS Access over ADO

=head1 DESCRIPTION

This driver is a subclass of L<DBIx::Class2::Storage::DBI::ADO> and
L<DBIx::Class2::Storage::DBI::ACCESS> for connecting to MS Access via
L<DBD::ADO>.

See the documentation for L<DBIx::Class2::Storage::DBI::ACCESS> for
information on the MS Access driver for L<DBIx::Class2>.

This driver implements workarounds for C<TEXT/IMAGE/MEMO> columns, sets the
L<cursor_class|DBIx::Class2::Storage::DBI/cursor_class> to
L<DBIx::Class2::Storage::DBI::ADO::MS_Jet::Cursor> to normalize returned
C<GUID> values and provides L<DBIx::Class2::InflateColumn::DateTime> support
...
L<problems|DBIx::Class2::Storage::DBI::ODBC::ACCESS/"TEXT/IMAGE/MEMO COLUMNS">
the L<ODBC|DBIx::Class2::Storage::DBI::ODBC::ACCESS> driver has with these types
...
L<ODBC|DBIx::Class2::Storage::DBI::ODBC::ACCESS> driver it is converted to
C<VARCHAR(255)>.
...
your L<connect_info|DBIx::Class2::Storage::DBI/connect_info>, it will be
multiplied by two and C<1> added, just as for the
L<ODBC|DBIx::Class2::Storage::DBI::ODBC::ACCESS> driver.
...
sub select_single {
  ...
  return @row unless
    $self->cursor_class->isa('DBIx::Class2::Storage::DBI::ADO::MS_Jet::Cursor');
...
sub datetime_parser_type {
  'DBIx::Class2::Storage::DBI::ADO::MS_Jet::DateTime::Format'
}
