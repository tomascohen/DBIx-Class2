package DBIx::Class2::Storage::DBI::Replicated;

BEGIN {
  use DBIx::Class2;
  die('The following modules are required for Replication ' . DBIx::Class2::Optional::Dependencies->req_missing_for ('replicated') . "\n" )
    unless DBIx::Class2::Optional::Dependencies->req_ok_for ('replicated');
}

use Moose;
use DBIx::Class2::Storage::DBI;
use DBIx::Class2::Storage::DBI::Replicated::Pool;
use DBIx::Class2::Storage::DBI::Replicated::Balancer;
use DBIx::Class2::Storage::DBI::Replicated::Types qw/BalancerClassNamePart DBICSchema DBICStorageDBI/;
...
DBIx::Class2::Storage::DBI::Replicated - BETA Replicated database support
...
L<DBIx::Class2::Storage::DBI::Replicated::Pool> and the replicants attribute for more.
...
Basically, any method request that L<DBIx::Class2::Storage::DBI> would normally
...
L<DBIx::Class2>. See L<DBIx::Class2::Optional::Dependencies> for more details.
...
The underlying L<DBIx::Class2::Schema> object this storage is attaching
...
to: L<DBIx::Class2::Storage::DBI::Replicated::Pool>.
...
has 'pool_type' => (
  is=>'rw',
  isa=>ClassName,
  default=>'DBIx::Class2::Storage::DBI::Replicated::Pool',
  handles=>{
    'create_pool' => 'new',
  },
);
...
See L<DBIx::Class2::Storage::DBI::Replicated::Pool> for available arguments.
...
has 'balancer_type' => (
  ...
  coerce=>1,
  required=>1,
  default=> 'DBIx::Class2::Storage::DBI::Replicated::Balancer::First',
  handles=>{
    'create_balancer' => 'new',
  },
);
...
Contains a hashref of initialized information to pass to the Balancer object.
See L<DBIx::Class2::Storage::DBI::Replicated::Balancer> for available arguments.
...
Is a L<DBIx::Class2::Storage::DBI::Replicated::Pool> or derived class.  This is a
...
has 'pool' => (
  is=>'ro',
  isa=>'DBIx::Class2::Storage::DBI::Replicated::Pool',
  lazy_build=>1,
  handles=>[qw/
    connect_replicants
    replicants
...
Is a L<DBIx::Class2::Storage::DBI::Replicated::Balancer> or derived class.  This
is a class that takes a pool (L<DBIx::Class2::Storage::DBI::Replicated::Pool>)

=cut

has 'balancer' => (
  is=>'rw',
  isa=>'DBIx::Class2::Storage::DBI::Replicated::Balancer',
  lazy_build=>1,
...
L<DBIx::Class2::Storage::DBI> interface.
...
my $method_dispatch = {
  writer => [qw/
    ...
    _do_query
    _dbh_execute
  /, Class::MOP::Class->initialize('DBIx::Class2::Storage::DBIHacks')->get_method_list ],
  reader => [qw/
    select
    select_single
    columns_info_for
  ...
  /,(
    ...
    grep
      ...
      ( Class::MOP::Class->initialize('DBIx::Class2::Storage::DBI')->get_all_method_names )
  )],
};

if (DBIx::Class2::_ENV_::DBICTEST) {
  ...
  if (my @cant = grep { ! DBIx::Class2::Storage::DBI->can($_) } keys %$seen) {
    die(join "\n", '',
...
Defines an object that implements the read side of L<DBIx::Class2::Storage::DBI>.
...
Defines an object that implements the write side of L<DBIx::Class2::Storage::DBI>,
...
around connect_info => sub {
  ...
  return preserve_context {
    ...
    DBIx::Class2::Storage::DBI::Replicated::WithDSN->meta->apply($master);
...
L<DBIx::Class2::Schema> when instantiating its storage passed itself as the
...
sub _build_master {
  my $self = shift @_;
  my $master = DBIx::Class2::Storage::DBI->new($self->schema);
  $master
}
...
top of the args, since L<DBIx::Class2::Storage::DBI> needs it, and any
...
sets the L<DBIx::Class2::Storage::DBI/unsafe> option on all storages or returns
...
sets the L<DBIx::Class2::Storage::DBI/disable_sth_caching> option on all storages
...
returns the highest Replicant L<DBIx::Class2::Storage::DBI/lag_behind_master>
setting
...
L<DBIx::Class2::Storage::DBI/is_replicating>
...
calls L<DBIx::Class2::Storage::DBI/connect_call_datetime_setup> for all storages
...
calls L<DBIx::Class2::Storage::DBI/connect_call_rebase_sqlmaker> for all storages
...
L<< $result->discard_changes|DBIx::Class2::Row/discard_changes >>)
