package DBIx::Class2::Storage::DBI::MSSQL;
...
__PACKAGE__->sql_maker_class('DBIx::Class2::SQLMaker::MSSQL');

__PACKAGE__->sql_quote_char([qw/[ ]/]);

__PACKAGE__->datetime_parser_type (
  'DBIx::Class2::Storage::DBI::MSSQL::DateTime::Format'
);
...
sub _select_args_to_query {
  ...
  if (
    ...
    $self->throw_exception(
      'An ordered subselect encountered - this is not safe! Please see "Ordered Subselects" in DBIx::Class2::Storage::DBI::MSSQL'
...
DBIx::Class2::Storage::DBI::MSSQL - Base Class for Microsoft SQL Server support
in DBIx::Class2

=head1 SYNOPSIS

This is the base class for Microsoft SQL Server support, used by
L<DBIx::Class2::Storage::DBI::ODBC::Microsoft_SQL_Server> and
...
L<has_many|DBIx::Class2::Relationship/has_many> relationship with limit/group
...
L<resultset attribute|DBIx::Class2::ResultSet/ATTRIBUTES> C<unsafe_subselect_ok>.
