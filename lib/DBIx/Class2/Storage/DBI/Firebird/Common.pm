package DBIx::Class2::Storage::DBI::Firebird::Common;
...
DBIx::Class2::Storage::DBI::Firebird::Common - Driver Base Class for the Firebird RDBMS

=head1 DESCRIPTION

This class implements autoincrements for Firebird using C<RETURNING> as well as
L<auto_nextval|DBIx::Class2::ResultSource/auto_nextval>, savepoints and server
version detection.
...
__PACKAGE__->datetime_parser_type(
  'DBIx::Class2::Storage::DBI::InterBase::DateTime::Format'
);
...
greater, L<auto_nextval|DBIx::Class2::ResultSource/auto_nextval> however should
