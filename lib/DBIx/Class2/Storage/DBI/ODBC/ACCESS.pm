package DBIx::Class2::Storage::DBI::ODBC::ACCESS;
...
DBIx::Class2::Storage::DBI::ODBC::ACCESS - Support specific to MS Access over ODBC

=head1 DESCRIPTION

This class implements support specific to Microsoft Access over ODBC.

It is a subclass of L<DBIx::Class2::Storage::DBI::ODBC> and
L<DBIx::Class2::Storage::DBI::ACCESS>, see those classes for more
information.

It is loaded automatically by L<DBIx::Class2::Storage::DBI::ODBC> when it
detects a MS Access back-end.

This driver implements workarounds for C<IMAGE> and C<MEMO> columns, and
L<DBIx::Class2::InflateColumn::DateTime> support for C<DATETIME> columns.
...
drivers (like L<ADO|DBIx::Class2::Storage::DBI::ADO::MS_Jet>) will automatically
...
L<connect_info|DBIx::Class2::Storage::DBI/connect_info>; but if you set this
...
sub datetime_parser_type {
  'DBIx::Class2::Storage::DBI::ODBC::ACCESS::DateTime::Format'
}
