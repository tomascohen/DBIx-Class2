package DBIx::Class2::Storage::DBI::ODBC::Microsoft_SQL_Server;
use strict;
use warnings;
...
DBIx::Class2::Storage::DBI::ODBC::Microsoft_SQL_Server - Support specific
to Microsoft SQL Server over ODBC

=head1 DESCRIPTION

This class implements support specific to Microsoft SQL Server over ODBC.  It is
loaded automatically by DBIx::Class2::Storage::DBI::ODBC when it detects a
MSSQL back-end.
...
Set your C<$dsn> in L<connect_info|DBIx::Class2::Storage::DBI/connect_info> as follows:
