package DBIx::Class2::Storage::DBI::ODBC::Firebird;

use strict;
use warnings;
use base qw/
  DBIx::Class2::Storage::DBI::ODBC
  DBIx::Class2::Storage::DBI::Firebird::Common
/;
use mro 'c3';
use Try::Tiny;
use namespace::clean;
...
DBIx::Class2::Storage::DBI::ODBC::Firebird - Driver for using the Firebird RDBMS
through ODBC

=head1 DESCRIPTION

Most functionality is provided by
L<DBIx::Class2::Storage::DBI::Firebird::Common>, see that driver for details.
...
issue that the L<DBD::InterBase|DBIx::Class2::Storage::DBI::InterBase> or the
L<DBD::Firebird|DBIx::Class2::Storage::DBI::Firebird> based driver does. This
