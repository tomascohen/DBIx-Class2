package DBIx::Class2::Storage::DBI::SQLAnywhere;

use strict;
use warnings;
use base qw/DBIx::Class2::Storage::DBI::UniqueIdentifier/;
use mro 'c3';
use Try::Tiny;
use namespace::clean;
...
__PACKAGE__->cursor_class('DBIx::Class2::Storage::DBI::SQLAnywhere::Cursor');

=head1 NAME

DBIx::Class2::Storage::DBI::SQLAnywhere - Driver for SQL Anywhere

=head1 DESCRIPTION

This class implements autoincrements for SQL Anywhere and provides
L<DBIx::Class2::InflateColumn::DateTime> support and support for the
C<uniqueidentifier> type (via
L<DBIx::Class2::Storage::DBI::SQLAnywhere::Cursor>.)
...
Recommended L<connect_info|DBIx::Class2::Storage::DBI/connect_info> settings:
...
sub select_single {
  ...
  return @row
    unless $self->cursor_class->isa('DBIx::Class2::Storage::DBI::SQLAnywhere::Cursor');
...
A L<DBIx::Class2> application can use a lot of cursors, due to the usage of
