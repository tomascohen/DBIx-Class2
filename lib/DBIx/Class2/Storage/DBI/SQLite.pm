package DBIx::Class2::Storage::DBI::SQLite;
...
use DBIx::Class2::_Util qw(modver_gt_or_eq sigwarn_silencer);
use DBIx::Class2::Carp;
use Try::Tiny;
use namespace::clean;

__PACKAGE__->sql_maker_class('DBIx::Class2::SQLMaker::SQLite');
...
DBIx::Class2::Storage::DBI::SQLite - Automatic primary key class for SQLite
...
=item RT79576
  ...
  * You are or were using DBIx::Class2 versions between 0.08191 and 0.08209
...
An unfortunate chain of events led to DBIx::Class2 silently hitting the problem
...
DBIx::Class2 call to C<< $sth->bind_param >> would be executed in a way that
...
Even if you upgrade DBIx::Class2 (which works around the bug starting from
version 0.08210) you may still have corrupted/incorrect data in your database.
DBIx::Class2 warned about this condition for several years, hoping to give
...
sub _dbh_execute {
  if (
    (
      DBIx::Class2::_ENV_::IV_SIZE < 8
        or
      DBIx::Class2::_ENV_::OS_NAME eq 'MSWin32'
    )
      and
...
In L<connect_info|DBIx::Class2::Storage::DBI/connect_info> to turn on foreign key
