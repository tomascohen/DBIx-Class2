package DBIx::Class2::Storage::DBI::Sybase;
...
DBIx::Class2::Storage::DBI::Sybase - Base class for drivers using
L<DBD::Sybase>
...
sub _init {
  ...
  my $self = shift;
  if (! $self->isa('DBIx::Class2::Storage::DBI::Sybase::FreeTDS') and $self->_using_freetds) {
    require DBIx::Class2::Storage::DBI::Sybase::FreeTDS;
    ...
    no strict 'refs';
    @{"${trait_class}::ISA"} = ($class, 'DBIx::Class2::Storage::DBI::Sybase::FreeTDS', @isa);
