package DBIx::Class2::Storage::DBI::AutoCast;
...
DBIx::Class2::Storage::DBI::AutoCast - Storage component for RDBMS requiring explicit placeholder typing
...
As long as a column L<data_type|DBIx::Class2::ResultSource/add_columns> is
defined and resolves to a base RDBMS native type via
L<_native_data_type|DBIx::Class2::Storage::DBI/_native_data_type> as
...
L<connect_info|DBIx::Class2::Storage::DBI/connect_info> as:
...
in L<connect_info|DBIx::Class2::Storage::DBI/connect_info>.
