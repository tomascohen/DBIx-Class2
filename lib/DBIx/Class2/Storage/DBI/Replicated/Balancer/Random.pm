package DBIx::Class2::Storage::DBI::Replicated::Balancer::Random;

use Moose;
with 'DBIx::Class2::Storage::DBI::Replicated::Balancer';
use DBIx::Class2::Storage::DBI::Replicated::Types 'Weight';
use namespace::clean -except => 'meta';

=head1 NAME

DBIx::Class2::Storage::DBI::Replicated::Balancer::Random - A 'random' Balancer
