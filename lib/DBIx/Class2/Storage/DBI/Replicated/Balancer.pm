package DBIx::Class2::Storage::DBI::Replicated::Balancer;

use Moose::Role;
requires 'next_storage';
use MooseX::Types::Moose qw/Int/;
use DBIx::Class2::Storage::DBI::Replicated::Pool;
use DBIx::Class2::Storage::DBI::Replicated::Types qw/DBICStorageDBI/;
use namespace::clean -except => 'meta';

=head1 NAME

DBIx::Class2::Storage::DBI::Replicated::Balancer - A Software Load Balancer

=head1 SYNOPSIS

This role is used internally by L<DBIx::Class2::Storage::DBI::Replicated>.

=head1 DESCRIPTION

Given a pool (L<DBIx::Class2::Storage::DBI::Replicated::Pool>) of replicated
database's (L<DBIx::Class2::Storage::DBI::Replicated::Replicant>), defines a
...
L<DBIx::Class2::Storage::DBI::Replicated::Pool/validate_replicants>
...
The L<DBIx::Class2::Storage::DBI> object that is the master database all the
...
The L<DBIx::Class2::Storage::DBI::Replicated::Pool> object that we are trying to
balance.
...
your own subclasses of L<DBIx::Class2::Storage::DBI::Replicated::Balancer> to
