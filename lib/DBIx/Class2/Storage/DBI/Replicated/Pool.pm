package DBIx::Class2::Storage::DBI::Replicated::Pool;

use Moose;
use DBIx::Class2::Storage::DBI::Replicated::Replicant;
use Scalar::Util 'reftype';
use DBI ();
use MooseX::Types::Moose qw/Num Int ClassName HashRef/;
use DBIx::Class2::Storage::DBI::Replicated::Types 'DBICStorageDBI';
use Try::Tiny;
...
DBIx::Class2::Storage::DBI::Replicated::Pool - Manage a pool of replicants

=head1 SYNOPSIS

This class is used internally by L<DBIx::Class2::Storage::DBI::Replicated>.  You
...
L<DBIx::Class2::Storage::DBI/lag_behind_master> method.  The default is 0.  In
...
need to subclass L<DBIx::Class2::Storage::DBI::Replicated::Replicant> you should
...
has 'replicant_type' => (
  ...
  isa=>ClassName,
  required=>1,
  default=>'DBIx::Class2::Storage::DBI',
  handles=>{
...
database, create an L<DBIx::Class2::Storage::DBI::Replicated::Replicant> object
...
## class to apply the Replicant role.
  ...
  DBIx::Class2::Storage::DBI::Replicated::Replicant->meta->apply($replicant);
...
See L<DBIx::Class2::Storage::DBI> for more about checking if a replicating
