package DBIx::Class2::Storage::DBI::Replicated::Replicant;

use Moose::Role;
requires qw/_query_start/;
with 'DBIx::Class2::Storage::DBI::Replicated::WithDSN';
...
DBIx::Class2::Storage::DBI::Replicated::Replicant - A replicated DBI Storage Role

=head1 SYNOPSIS

This class is used internally by L<DBIx::Class2::Storage::DBI::Replicated>.
...
for L<DBIx::Class2::Storage::DBI::Replicated> for more details.
...
L<DBIx::Class2::Storage::DBI::Replicated/is_replicating> and
L<DBIx::Class2::Storage::DBI::Replicated/lag_behind_master>.
