...
DBIx::Class2::Storage::DBI::Replicated::Introduction - Minimum Need to Know

=head1 SYNOPSIS

This is an introductory document for L<DBIx::Class2::Storage::DBI::Replicated>.
...
L<DBIx::Class2> supports a framework for using database replication. This system
...
By default, when you start L<DBIx::Class2>, your Schema (L<DBIx::Class2::Schema>)
...
L<DBIx::Class2::Storage::DBI::mysql>  Your storage type class will contain
database specific code to help smooth over the differences between databases
and let L<DBIx::Class2> do its thing.
...
storage itself (L<DBIx::Class2::Storage::DBI::Replicated>).  A replicated storage
takes a pool of replicants (L<DBIx::Class2::Storage::DBI::Replicated::Pool>)
and a software balancer (L<DBIx::Class2::Storage::DBI::Replicated::Balancer>).
...
Then, you need to connect your L<DBIx::Class2::Schema>.

  $schema->connection($dsn, $user, $pass);

Let's break down the settings.  The method L<DBIx::Class2::Schema/storage_type>
...
replicated storage.  L<DBIx::Class2::Storage::DBI::Replicated/balancer_type> is
...
L<DBIx::Class2::Storage::DBI::Replicated::Balancer::First>,
L<DBIx::Class2::Storage::DBI::Replicated::Balancer::Random>.
...
This object (L<DBIx::Class2::Storage::DBI::Replicated::Pool>) manages all the
