package DBIx::Class2::Storage::DBI::InterBase;

use strict;
use warnings;
use base qw/DBIx::Class2::Storage::DBI::Firebird::Common/;
use mro 'c3';
use Try::Tiny;
use namespace::clean;
...
DBIx::Class2::Storage::DBI::InterBase - Driver for the Firebird RDBMS via
L<DBD::InterBase>

=head1 DESCRIPTION

This driver is a subclass of L<DBIx::Class2::Storage::DBI::Firebird::Common> for
use with L<DBD::InterBase>, see that driver for general details.

You need to use either the
L<disable_sth_caching|DBIx::Class2::Storage::DBI/disable_sth_caching> option or
...
L<ODBC|DBIx::Class2::Storage::DBI::ODBC::Firebird> driver, which is more suitable
for long running processes such as under L<Catalyst>.

To turn on L<DBIx::Class2::InflateColumn::DateTime> support, see
...
In L<connect_info|DBIx::Class2::Storage::DBI/connect_info> to set the
L<DBD::InterBase> C<ib_softcommit> option.

You need either this option or C<< disable_sth_caching => 1 >> for
L<DBIx::Class2> code to function correctly (otherwise you may get C<no statement
executing> errors.) Or use the L<ODBC|DBIx::Class2::Storage::DBI::ODBC::Firebird>
driver.
...
In L<connect_info|DBIx::Class2::Storage::DBI/connect_info> to set the date and
...
For L<DBIx::Class2::Storage::DBI::ODBC::Firebird>, this is a noop.
...
L<disable_sth_caching|DBIx::Class2::Storage::DBI/disable_sth_caching> as a
workaround for the C<no statement executing> errors, this of course adversely
affects performance.

Alternately, use the L<ODBC|DBIx::Class2::Storage::DBI::ODBC::Firebird> driver.
