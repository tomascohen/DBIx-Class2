package DBIx::Class2::Storage::DBI::ACCESS;

use strict;
use warnings;
use base 'DBIx::Class2::Storage::DBI::UniqueIdentifier';
use mro 'c3';

use DBI ();

__PACKAGE__->sql_limit_dialect ('Top');
__PACKAGE__->sql_maker_class('DBIx::Class2::SQLMaker::ACCESS');
...
DBIx::Class2::Storage::DBI::ACCESS - Support specific to MS Access

=head1 DESCRIPTION

This is the base class for Microsoft Access support.

This driver supports L<last_insert_id|DBIx::Class2::Storage::DBI/last_insert_id>,
empty inserts for tables with C<AUTOINCREMENT> columns, nested transactions via
L<auto_savepoint|DBIx::Class2::Storage::DBI/auto_savepoint>, C<GUID> columns via
L<DBIx::Class2::Storage::DBI::UniqueIdentifier>.
...
L<auto_nextval|DBIx::Class2::ResultSource/auto_nextval> you will need to set a
L<new_guid|DBIx::Class2::Storage::DBI::UniqueIdentifier/new_guid> callback, like
so:
