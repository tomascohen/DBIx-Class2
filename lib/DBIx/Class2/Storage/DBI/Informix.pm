package DBIx::Class2::Storage::DBI::Informix;
use strict;
use warnings;
...
__PACKAGE__->datetime_parser_type (
  'DBIx::Class2::Storage::DBI::Informix::DateTime::Format'
);
...
DBIx::Class2::Storage::DBI::Informix - Base Storage Class for Informix Support
...
In L<connect_info|DBIx::Class2::Storage::DBI/connect_info> to set the C<DATE> and
C<DATETIME> formats.
