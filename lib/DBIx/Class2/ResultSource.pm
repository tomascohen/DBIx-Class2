package DBIx::Class2::ResultSource;

use strict;
use warnings;

use base qw/DBIx::Class2::ResultSource::RowParser DBIx::Class2/;

use DBIx::Class2::ResultSet;
use DBIx::Class2::ResultSourceHandle;
...
DBIx::Class2::ResultSource - Result source object
...
sources, for example L<DBIx::Class2::ResultSource::Table>. Table is the
default result source type, so one is created for you when defining a
result class as described in the synopsis above.

More specifically, the L<DBIx::Class2::Core> base class pulls in the
L<DBIx::Class2::ResultSourceProxy::Table> component, which defines
the L<table|DBIx::Class2::ResultSourceProxy::Table/table> method.
When called, C<table> creates and stores an instance of
L<DBIx::Class2::ResultSource::Table>. Luckily, to use tables as result
sources, you don't need to remember any of this.

Result sources representing select queries, or views, can also be
created, see L<DBIx::Class2::ResultSource::View> for full details.
...
sub new {
  ...
  $new->{resultset_class} ||= 'DBIx::Class2::ResultSet';
...
L<Result|DBIx::Class2::Manual::ResultClass> objects. You can change the name of the accessor
...
keys are currently recognised/used by DBIx::Class2:
...
L<SQL::Translator::Producer::DBIx::Class2::File> producer, or the
L<DBIx::Class2::Schema::Loader> module.
...
schema, see L<DBIx::Class2::Schema/deploy>.
...
from your schema, see L<DBIx::Class2::Schema/deploy>.
...
L<DBIx::Class2::Row/copy>. It is also used by
L<DBIx::Class2::Schema/deploy>.
...
create tables from your schema, see L<DBIx::Class2::Schema/deploy>.
...
See the note on L<DBIx::Class2::Row/new> for more information about possible
...
generate a new key value. If not specified, L<DBIx::Class2::PK::Auto>
...
L<data_type|DBIx::Class2::ResultSource/data_type> whose values you want to
automatically generate using C<NEWID()>, unless they are a primary key in which
case this will be done anyway.

=item extra

This is used by L<DBIx::Class2::Schema/deploy> and L<SQL::Translator>
...
See
L<DBIx::Class2::Manual::Intro/The Significance and Importance of Primary Keys>
for more info.
...
name as the C<key> attribute to L<DBIx::Class2::ResultSet/find>. Then
...
the schema via L<DBIx::Class2::Schema/create_ddl_dir> or
L<DBIx::Class2::Schema/deploy>.
...
the L<DBIx::Class2::Schema/sqlt_deploy_hook>.

See L<DBIx::Class2::Manual::Cookbook/Adding Indexes And Functions To
...
handle, override L<DBIx::Class2::Schema/deploy> in your Schema class
and call L<dbh_do|DBIx::Class2::Storage::DBI/dbh_do>.
...
and use your own result inflator. See L<DBIx::Class2::ResultSet/result_class>
for more details.

Please note that setting this to something like
L<DBIx::Class2::ResultClass::HashRefInflator> will make every result unblessed
and make life more difficult.  Inflators like those are better suited to
temporary usage via L<DBIx::Class2::ResultSet/result_class>.
...
L<DBIx::Class2::ResultSet>, and set it here. If called with no arguments,
...
=item Arguments: L<\%attrs|DBIx::Class2::ResultSet/ATTRIBUTES>

=item Return Value: L<\%attrs|DBIx::Class2::ResultSet/ATTRIBUTES>
...
L<DBIx::Class2::ResultSet> produced from this result source.
...
via L<DBIx::Class2::ResultSource::View>.
...
=item Arguments: L<$schema?|DBIx::Class2::Schema>

=item Return Value: L<$schema|DBIx::Class2::Schema>

=back

  my $schema = $source->schema();

Sets and/or returns the L<DBIx::Class2::Schema> object to which this
  ...
  if (@_ > 1) {
    ...
    $_[0]->{schema} || do {
      ...
      $err .= ' You need to use $schema->thaw() or manually set'
            . ' $DBIx::Class2::ResultSourceHandle::thaw_schema while thawing.'
        if $_[0]->{_detached_thaw};

      DBIx::Class2::Exception->throw($err);
    };
  }
}
...
=item Return Value: L<$storage|DBIx::Class2::Storage>

=back

  $source->storage->debug(1);

Returns the L<storage handle|DBIx::Class2::Storage> for the current schema.
...
L<DBIx::Class2::Relationship> describes a series of methods which
...
=item Return Value: L<@rel_names|DBIx::Class2::Relationship>
...
=item Arguments: L<$rel_name|DBIx::Class2::Relationship>

=item Return Value: L<\%rel_data|DBIx::Class2::Relationship::Base/add_relationship>

=back

Returns a hash of relationship information for the specified relationship
name. The keys/values are as specified for L<DBIx::Class2::Relationship::Base/add_relationship>.
...
### API Design? What's that...? (a backwards compatible shim, kill me now)
  ...
  for (0,1) {
    ...
    if ( defined blessed $res_args[$_] ) {
      ...
      if ($res_args[$_]->isa('DBIx::Class2::ResultSet')) {
...
# TEMP
  ...
  $self->throw_exception( "Argument 'self_result_object' must be an object inheriting from DBIx::Class2::Row" )
    if (
      exists $args->{self_result_object}
        and
      ( ! defined blessed $args->{self_result_object} or ! $args->{self_result_object}->isa('DBIx::Class2::Row') )
    )
  ;
...
# TEMP
    ...
    if (defined blessed $args->{foreign_values}) {
      ...
      $self->throw_exception( "Objects supplied as 'foreign_values' ($args->{foreign_values}) must inherit from DBIx::Class2::Row" )
        unless $args->{foreign_values}->isa('DBIx::Class2::Row');
...
=item Return Value: L<$source_handle|DBIx::Class2::ResultSourceHandle>

=back

Obtain a new L<result source handle instance|DBIx::Class2::ResultSourceHandle>
...
sub handle {
  return DBIx::Class2::ResultSourceHandle->new({
