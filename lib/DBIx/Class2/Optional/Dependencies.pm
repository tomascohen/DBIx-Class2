package DBIx::Class2::Optional::Dependencies;
...
my $reqs = {
  replicated => {
    ...
    pod => {
      ...
      desc => 'Modules required for L<DBIx::Class2::Storage::DBI::Replicated>',
    },
  },
  ...
  admin => {
    ...
    pod => {
      title => 'DBIx::Class2::Admin',
      desc => 'Modules required for the DBIx::Class2 administrative library',
    },
  },
  ...
  admin_script => {
    ...
    pod => {
      title => 'dbicadmin',
      desc => 'Modules required for the CLI DBIx::Class2 interface dbicadmin',
    },
  },
  ...
  deploy => {
    ...
    pod => {
      ...
      desc => 'Modules required for L<DBIx::Class2::Storage::DBI/deployment_statements> and L<DBIx::Class2::Schema/deploy>',
    },
  },
...
sub _gen_pod {
  ...
  $distver ||=
    eval { require DBIx::Class2; DBIx::Class2->VERSION; }
      ||
    die
"\n\n---------------------------------------------------------------------\n" .
'Unable to load core DBIx::Class2 module to determine current version, '.
...
Somewhere in your build-file (e.g. L<Module::Install>'s Makefile.PL):
  ...
  configure_requires 'DBIx::Class2' => '$distver';
...
EOS
    '=head1 DESCRIPTION',
    <<'EOD',
Some of the less-frequently used features of L<DBIx::Class2> have external
...
of such dependencies, for DBIx::Class2 core authors, and DBIx::Class2 extension
authors alike.
EOD
...
EOD
  ...
  push @chunks, (
    ...
    '=back',
    <<'EOD',
This method should be used by DBIx::Class2 packagers, to get a hashref of all
...
EOD
    ...
    '=back',
    <<'EOD',
This method should be used by DBIx::Class2 extension authors, to determine the
version of modules a specific feature requires in the B<current> version of
DBIx::Class2. See the L</SYNOPSIS> for a real-world
example.
EOD
...
This method would normally be used by DBIx::Class2 core-module author, to
