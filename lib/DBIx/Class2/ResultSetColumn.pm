package DBIx::Class2::ResultSetColumn;
...
use DBIx::Class2::_Util 'fail_on_internal_wantarray';
use namespace::clean;

=head1 NAME

  DBIx::Class2::ResultSetColumn - helpful methods for messing
...
=head2 new
  ...
  my $obj = DBIx::Class2::ResultSetColumn->new($rs, $column);

Creates a new resultset column object from the resultset and column
passed as params. Used internally by L<DBIx::Class2::ResultSet/get_column>.
...
=item Return Value: \[ $sql, L<@bind_values|DBIx::Class2::ResultSet/DBIC BIND VALUES> ]
...
Much like L<DBIx::Class2::ResultSet/next> but just returning the
one value.
...
Much like L<DBIx::Class2::ResultSet/all> but returns values rather
than result objects.
...
Much like L<DBIx::Class2::ResultSet/reset>.
...
Much like L<DBIx::Class2::ResultSet/first> but just returning the one value.
...
Much like L<DBIx::Class2::ResultSet/single> fetches one and only one column
