...
DBIx::Class2::Cursor - Abstract object representing a query cursor on a
resultset.
...
Virtual method. Returns a new L<DBIx::Class2::Cursor> object.
...
Virtual method. Returns all rows in the L<DBIx::Class2::ResultSet>.
