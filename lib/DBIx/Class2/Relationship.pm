package DBIx::Class2::Relationship;
...
DBIx::Class2::Relationship - Inter-table relationships
...
See L<DBIx::Class2::Manual::Cookbook> for more.

=head1 DESCRIPTION

The word I<Relationship> has a specific meaning in DBIx::Class2, see
the definition in the L<Glossary|DBIx::Class2::Manual::Glossary/Relationship>.
...
technique that L<DBIx::Class2> provides. To create efficient database queries,
...
L<Result|DBIx::Class2::Manual::Glossary/"Result"> objects that represent the items
of your table. From L<ResultSet|DBIx::Class2::Manual::Glossary/"ResultSet"> objects,
...
L<DBIx::Class2::Relationship::Base>.
...
See L<DBIx::Class2::Relationship::Base/condition> for full documentation on
definition of the C<cond> argument.

See L<DBIx::Class2::Relationship::Base/attributes> for documentation on the
...
L<Result|DBIx::Class2::Manual::ResultClass> object to retrieve the instance of the foreign
class matching this relationship. This is often called the
C<relation(ship) name>.

Use this accessor_name in L<DBIx::Class2::ResultSet/join>
or L<DBIx::Class2::ResultSet/prefetch> to join to the foreign table
...
more info see L<DBIx::Class2::Relationship::Base/condition>.
...
L<nullable|DBIx::Class2::ResultSource/is_nullable> you probably want to set
the L<join_type|DBIx::Class2::Relationship::Base/join_type> attribute to
...
L<join|DBIx::Class2::ResultSet/join> or
L<prefetch|DBIx::Class2::ResultSet/prefetch>).
...
See L<DBIx::Class2::Relationship::Base/attributes> for documentation on relationship
methods and valid relationship attributes. Also see L<DBIx::Class2::ResultSet>
for a L<list of standard resultset attributes|DBIx::Class2::ResultSet/ATTRIBUTES>
...
=item Arguments: $accessor_name, $related_class, $their_fk_column|\%cond|\@cond|\&cond?, L<\%attrs?|DBIx::Class2::ResultSet/ATTRIBUTES>
...
This argument is the name of the method you can call on a
L<Result|DBIx::Class2::Manual::ResultClass> object to retrieve a resultset of the related
...
L<DBIx::Class2::Relationship::Base/"create_related">.
...
See L<DBIx::Class2::Relationship::Base/attributes> for documentation on
relationship methods and valid relationship attributes. Also see
L<DBIx::Class2::ResultSet> for a L<list of standard resultset
attributes|DBIx::Class2::ResultSet/ATTRIBUTES> which can be assigned to
...
you probably just meant to use C<DBIx::Class2::Relationship/belongs_to>.
...
L<DBIx::Class2::Relationship/might_have> relationship.
...
L<DBIx::Class2::Relationship/might_have>.

=head2 many_to_many

=over 4

=item Arguments: $accessor_name, $link_rel_name, $foreign_rel_name, L<\%attrs?|DBIx::Class2::ResultSet/ATTRIBUTES>

=back

C<many_to_many> is a I<Relationship bridge> which has a specific
meaning in DBIx::Class2, see the definition in the
L<Glossary|DBIx::Class2::Manual::Glossary/Relationship bridge>.
...
This argument is the name of the method you can call on a
L<Result|DBIx::Class2::Manual::ResultClass> object to retrieve the rows matching this
relationship.

On a many_to_many, unlike other relationships, this cannot be used in
L<DBIx::Class2::ResultSet/search> to join tables. Use the relations
