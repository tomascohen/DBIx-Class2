...
package # Hide from PAUSE
  DBIx::Class2::Version::TableCompat;
use base 'DBIx::Class2::Core';
...
package # Hide from PAUSE
  DBIx::Class2::Version;
use base 'DBIx::Class2::Schema';
use strict;
use warnings;

__PACKAGE__->register_class('Table', 'DBIx::Class2::Version::Table');

package # Hide from PAUSE
  DBIx::Class2::VersionCompat;
use base 'DBIx::Class2::Schema';
use strict;
use warnings;

__PACKAGE__->register_class('TableCompat', 'DBIx::Class2::Version::TableCompat');
...
DBIx::Class2::Schema::Versioned - DBIx::Class2::Schema plugin for Schema upgrades
...
L<DBIx::Class2::DeploymentHandler> is a much more powerful alternative to this
...
L<DBIx::Class2::Schema/ddl_filename>) then create a diff using your create DDL
...
package DBIx::Class2::Schema::Versioned;
...
Same as L<DBIx::Class2::Schema/deploy> but also calls C<install>.
...
normally you will have created this using L<DBIx::Class2::Schema/create_ddl_dir>.
...
sub _on_connect
{
  ...
  $self->{vschema} = DBIx::Class2::Version->connect(
    sub { $w_storage->dbh },
  ...
  unless ($self->_source_exists($vtable)) {
    my $vtable_compat = DBIx::Class2::VersionCompat->connect(sub { $w_storage->dbh })->resultset('TableCompat');
...
sub _create_db_to_schema_diff {
  ...
  unless (DBIx::Class2::Optional::Dependencies->req_ok_for ('deploy')) {
    $self->throw_exception("Unable to proceed without " . DBIx::Class2::Optional::Dependencies->req_missing_for ('deploy') );
  }
  ...
  $dbic_tr->parser('SQL::Translator::Parser::DBIx::Class2');
  $dbic_tr->data($self);
  $dbic_tr->producer($db);
