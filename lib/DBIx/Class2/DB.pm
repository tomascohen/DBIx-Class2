...
use DBIx::Class2::ClassResolver::PassThrough;
use DBI;
use Scalar::Util 'blessed';
use namespace::clean;

unless ($INC{"DBIx/Class/CDBICompat.pm"}) {
  warn "IMPORTANT: DBIx::Class2::DB is DEPRECATED AND *WILL* BE REMOVED. DO NOT USE.\n";
}
...
DBIx::Class2::DB - (DEPRECATED) classdata schema component

=head1 DESCRIPTION

This class is designed to support the Class::DBI connection-as-classdata style
for DBIx::Class2. You are *strongly* recommended to use a DBIx::Class2::Schema
instead; DBIx::Class2::DB will not undergo new development and will be moved
...
Sets or gets the storage backend. Defaults to L<DBIx::Class2::Storage::DBI>.
...
L<DBIx::Class2::ClassResolver::Passthrough>, which returns whatever you give
...
Creates a class method ->schema_instance which contains a DBIx::Class2::Schema;
all class-method operations are proxies through to this object. If you don't
call ->connection in your DBIx::Class2::DB subclass at load time you *must*
...
sub setup_schema_instance {
  my $class = shift;
  my $schema = {};
  bless $schema, 'DBIx::Class2::Schema';
...
is rethrown. See L<DBIx::Class2::Schema/"txn_do"> for more details.
...
native L<DBIx::Class2::ResultSet> system.
...
# (with good reason) DBIx::Class2::Schema copies the result source for
