package DBIx::Class2::Admin;

# check deps
BEGIN {
  use DBIx::Class2;
  die('The following modules are required for DBIx::Class2::Admin ' . DBIx::Class2::Optional::Dependencies->req_missing_for ('admin') )
...
use DBIx::Class2::Admin::Types qw/DBICConnectInfo DBICHashRef/;
...
DBIx::Class2::Admin - Administration object for schemas
...
Toggle DBIx::Class2 debug output
...
install is here to help when you want to move to L<DBIx::Class2::Schema::Versioned> and have an existing
