package DBIx::Class2::InflateColumn;

use strict;
use warnings;

use base 'DBIx::Class2::Row';
use SQL::Abstract::Util 'is_literal_value';
use namespace::clean;

=head1 NAME

DBIx::Class2::InflateColumn - Automatically create references from column data
...
something else, see L<DBIx::Class2::FilterColumn>.

=head1 METHODS

=head2 inflate_column

Instruct L<DBIx::Class2> to inflate the given column.
...
sub inflate_column {
  ...
  $self->throw_exception("InflateColumn can not be used on a column with a declared FilterColumn filter")
    if defined $colinfo->{_filter_info} and $self->isa('DBIx::Class2::FilterColumn');
...
analogous to L<DBIx::Class2::Row/get_column> in that it only fetches a
...
analogous to L<DBIx::Class2::Row/set_column>.
...
as dirty. This is directly analogous to L<DBIx::Class2::Row/store_column>.
...
=item L<DBIx::Class2::Core> - This component is loaded as part of the
      C<core> L<DBIx::Class2> components; generally there is no need to
      load it directly
