...
DBIx::Class2::Ordered - Modify the position of objects in an ordered list.
...
position of DBIx::Class2 objects.
...
# keep in mind that you can not invoke L<DBIx::Class2::Row/update> like
...
L<DBIx::Class2::Row> methods only. If you use the
L<DBIx::Class2::ResultSet> versions of
L<update|DBIx::Class2::ResultSet/update> or
L<delete|DBIx::Class2::ResultSet/delete>, all logic present in this
module will be bypassed entirely (possibly resulting in a broken
order-tree). Instead always use the
L<update_all|DBIx::Class2::ResultSet/update_all> and
L<delete_all|DBIx::Class2::ResultSet/delete_all> methods, which will
invoke the corresponding L<row|DBIx::Class2::Row> method on every
...
and using transactions (see L<DBIx::Class2::Storage/txn_do>)
...
you will need to call L<DBIx::Class2::Row/discard_changes> to get an object
