package DBIx::Class2::CDBICompat;

use strict;
use warnings;
use base qw/DBIx::Class2::Core DBIx::Class2::DB/;

# Modules CDBICompat needs that DBIx::Class2 does not.
my @Extra_Modules = qw(
    Class::Trigger
...
DBIx::Class2::CDBICompat - Class::DBI Compatibility layer.
...
DBIx::Class2 features a fully featured compatibility layer with L<Class::DBI>
and some common plugins to ease transition for existing CDBI users.

This is not a wrapper or subclass of DBIx::Class2 but rather a series of plugins.  The result being that even though you're using the Class::DBI emulation layer you are still getting DBIx::Class2 objects.  You can use all DBIx::Class2 features and methods via CDBICompat.  This allows you to take advantage of DBIx::Class2 features without having to rewrite your CDBI code.


=head2 Plugins

CDBICompat is good enough that many CDBI plugins will work with CDBICompat, but many of the plugin features are better done with DBIx::Class2 methods.
