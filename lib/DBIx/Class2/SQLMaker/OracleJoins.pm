package DBIx::Class2::SQLMaker::OracleJoins;

use warnings;
use strict;

use base qw( DBIx::Class2::SQLMaker::Oracle );
...
DBIx::Class2::SQLMaker::OracleJoins - Pre-ANSI Joins-via-Where-Clause Syntax
...
Overrides DBIx::Class2::SQLMaker's select() method, which calls _oracle_joins()
...
=item L<DBIx::Class2::Storage::DBI::Oracle::WhereJoins> - Storage class using this

=item L<DBIx::Class2::SQLMaker> - Parent module

=item L<DBIx::Class2> - Duh
