...
BEGIN {
  ...
  die('The following extra modules are required for Oracle-based Storages ' . DBIx::Class2::Optional::Dependencies->req_missing_for ('id_shortener') . "\n" )
