package DBIx::Class2::SQLMaker::ClassicExtensions;
...
DBIx::Class2::SQLMaker::ClassicExtensions - Class containing generic enhancements to SQL::Abstract::Classic
...
a DBIx::Class2::SQLMaker-like provider. See
L<DBIx::Class2::Storage::DBI/connect_call_rebase_sqlmaker> for more info.
...
sub throw_exception { DBIx::Class2::Exception->throw($_[1]) }
