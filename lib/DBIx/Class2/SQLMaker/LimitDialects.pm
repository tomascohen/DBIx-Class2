...
package DBIx::Class2::SQLMaker::LimitDialects;
...
my $sigh = sub {
  require DBIx::Class2::_Util;
  require DBIx::Class2::SQLMaker;

  my( $meth ) = (caller(1))[3] =~ /([^:]+)$/;

  DBIx::Class2::_Util::emit_loud_diag(
    skip_frames => 1,
    msg => "The $meth() constant is now provided by DBIx::Class2::SQLMaker::ClassicExtensions: please adjust your code"
  );

  DBIx::Class2::SQLMaker::ClassicExtensions->$meth;
};
...
DBIx::Class2::SQLMaker::LimitDialects - SQL::Abstract::Limit-like functionality in DBIx::Class2::SQLMaker
...
locked within L<DBIx::Class2::ResultSource> classes. After reimplementation
of close to 80% of the L<SQL::Abstract::Limit> functionality it was deemed
more practical to simply make an independent DBIx::Class2-specific
...
may have much better luck using L<DBIx::Class2::ResultSet/software_limit>
instead.
