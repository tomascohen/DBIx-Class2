package DBIx::Class2::InflateColumn::File;
...
carp 'InflateColumn::File has entered a deprecation cycle. This component '
    ...
    .'DBIx::Class2::InflateColumn::FS. You can set the environment variable '
...
DBIx::Class2::InflateColumn::File -  DEPRECATED (superseded by DBIx::Class2::InflateColumn::FS)
...
=head2 Deprecation Notice
 ...
 mature and actively supported DBIx::Class2::InflateColumn::FS. You can set
 the environment variable DBIC_IC_FILE_NOWARN to a true value to disable
 this warning.

=head1 SYNOPSIS

In your L<DBIx::Class2> table class:
