package DBIx::Class2::InflateColumn::DateTime;
...
DBIx::Class2::InflateColumn::DateTime - Auto-create DateTime objects from date and datetime columns.
...
inflate/deflate with based on the type of DBIx::Class2::Storage::DBI::*
...
For more help with using components, see L<DBIx::Class2::Manual::Component/USING>.
...
Chains with the L<DBIx::Class2::Row/register_column> method, and sets
...
sub _pre_deflate_datetime {
  ...
  if (defined $info->{timezone}) {
    carp "You're using a floating timezone, please see the documentation of"
      . " DBIx::Class2::InflateColumn::DateTime for an explanation"
...
B<DEPRECATED> because this gets you into trouble using L<DBIx::Class2::Schema::Versioned>.
...
=item More information about the add_columns method, and column metadata,
      can be found in the documentation for L<DBIx::Class2::ResultSource>.
