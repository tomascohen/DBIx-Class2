...
DBIx::Class2::Row - Basic row methods
...
derived from L<DBIx::Class2::ResultSource> objects.

Result objects are returned from L<DBIx::Class2::ResultSet>s using the
L<create|DBIx::Class2::ResultSet/create>, L<find|DBIx::Class2::ResultSet/find>,
L<next|DBIx::Class2::ResultSet/next> and L<all|DBIx::Class2::ResultSet/all> methods,
as well as invocations of 'single' (
L<belongs_to|DBIx::Class2::Relationship/belongs_to>,
L<has_one|DBIx::Class2::Relationship/has_one> or
L<might_have|DBIx::Class2::Relationship/might_have>)
relationship accessors of L<Result|DBIx::Class2::Manual::ResultClass> objects.

=head1 NOTE

All "Row objects" derived from a Schema-attached L<DBIx::Class2::ResultSet>
object (such as a typical C<< L<search|DBIx::Class2::ResultSet/search>->
L<next|DBIx::Class2::ResultSet/next> >> call) are actually Result
instances, based on your application's
L<Result Class|DBIx::Class2::Manual::Glossary/Result Class>.

L<DBIx::Class2::Row> implements most of the row-based communication with the
underlying storage, but a Result class B<should not inherit from it directly>.
Usually, Result classes inherit from L<DBIx::Class2::Core>, which in turn
combines the methods from several classes, one of them being
L<DBIx::Class2::Row>.  Therefore, while many of the methods available to a
L<DBIx::Class2::Core>-derived Result class are described in the following
documentation, it does not detail all of the methods available to Result
objects.  Refer to L<DBIx::Class2::Manual::ResultClass> for more info.
...
L<DBIx::Class2::ResultSet> object.
...
L<DBIx::Class2::ResultSource> instance that is attached to a
L<DBIx::Class2::Schema> with a valid connection.
...
L<DBIx::Class2::Relationship::Base/set_from_related> for you. When
...
For a more involved explanation, see L<DBIx::Class2::ResultSet/create>.
...
=head2 $column_accessor
  ...
  # (inflated column via DBIx::Class2::InflateColumn::DateTime)
...
L<accessor|DBIx::Class2::ResultSource/accessor> name given during the
L<Result Class|DBIx::Class2::Manual::ResultClass> L<column definition
|DBIx::Class2::ResultSource/add_columns>. Like L</set_column>, this
...
entirely new row into the database, use L<DBIx::Class2::ResultSet/create>.

To fetch an uninserted result object, call
L<new_result|DBIx::Class2::ResultSet/new_result> on a resultset.

This will also insert any uninserted, related objects held inside this
one, see L<DBIx::Class2::ResultSet/create> for more details.
...
sub insert {
  ...
  for my $rel_name (keys %related_stuff) {
    ...
    if (! $self->{_rel_in_storage}{$rel_name}) {
      next unless (blessed $rel_obj && $rel_obj->isa('DBIx::Class2::Row'));
  ...
  foreach my $rel_name (keys %related_stuff) {
    ...
    if (@cands && blessed $cands[0] && $cands[0]->isa('DBIx::Class2::Row')
    ) {
      my $reverse = $rsrc->reverse_relationship_info($rel_name);
...
not. This is set to true when L<DBIx::Class2::ResultSet/find>,
L<DBIx::Class2::ResultSet/create> or L<DBIx::Class2::Row/insert>
are invoked.

Creating a result object using L<DBIx::Class2::ResultSet/new_result>, or
...
L<significance of primary keys|DBIx::Class2::Manual::Intro/The Significance and Importance of Primary Keys>
for more details).
...
hashref of the relationship, see L<DBIx::Class2::Relationship>. Any
database-level cascade or restrict will take precedence over a
DBIx-Class2-based cascading delete, since DBIx-Class2 B<deletes the
main row first> and only then attempts to delete any remaining related
rows.

If you delete an object within a txn_do() (see L<DBIx::Class2::Storage/txn_do>)
...
See also L<DBIx::Class2::ResultSet/delete>.
...
to L<has_column|DBIx::Class2::ResultSource/has_column>.

Returns a raw column value from the result object, if it has already
been fetched from the database or set by an accessor.

If an L<inflated value|DBIx::Class2::InflateColumn> has been set, it
will be deflated and returned.

Note that if you used the C<columns> or the C<select/as>
L<search attributes|DBIx::Class2::ResultSet/ATTRIBUTES> on the resultset from
...
See L<DBIx::Class2::InflateColumn> for how to setup inflation.
...
L<DBIx::Class2::Relationship/has_many> key, and create the related
...
See also L<DBIx::Class2::Relationship::Base/set_from_related>.
...
=item Return Value: L<$result|DBIx::Class2::Manual::ResultClass> copy
...
the L<column info attribute|DBIx::Class2::ResultSource/add_columns>
...
L<cascade_copy|DBIx::Class2::Relationship::Base> attribute. C<cascade_copy>
...
=item Arguments: L<$result_source|DBIx::Class2::ResultSource>, \%columndata, \%prefetcheddata

=item Return Value: L<$result|DBIx::Class2::Manual::ResultClass>

=back

All L<DBIx::Class2::ResultSet> methods that retrieve data from the
...
your Result class. See L<DBIx::Class2::ResultSource/result_class>.

Different types of results can also be created from a particular
L<DBIx::Class2::ResultSet>, see L<DBIx::Class2::ResultSet/result_class>.
  ...
  if ($prefetch) {
    for my $rel_name ( keys %$prefetch ) {
      ...
      if (
        @{ $prefetch->{$rel_name} || [] }
          and
        ref($prefetch->{$rel_name}) ne $DBIx::Class2::ResultSource::RowParser::Util::null_branch_class
      ) {
...
Accessor to the L<DBIx::Class2::ResultSource> this object was created from.
...
L<DBIx::Class2::ResultSource/add_columns>
...
entire
 L<primary key|DBIx::Class2::Manual::Intro/The Significance and Importance of Primary Keys>
...
L<DBIx::Class2::ResultSet/ATTRIBUTES>.
...
Note: If you are using L<DBIx::Class2::Storage::DBI::Replicated> as your
storage, a default of
L<< C<< { force_pool => 'master' } >>
|DBIx::Class2::Storage::DBI::Replicated/SYNOPSIS >>  is automatically set for
you. Prior to C<< DBIx::Class2 0.08109 >> (before 2010) one would have been
...
See L<DBIx::Class2::Schema/throw_exception>.
...
Actually implemented in L<DBIx::Class2::PK>
