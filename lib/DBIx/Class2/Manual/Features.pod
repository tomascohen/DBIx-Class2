...
DBIx::Class2::Manual::Features - A boatload of DBIx::Class2 features with links to respective documentation

=head1 META

=head2 Large Community

There are L<hundres of DBIC contributors|DBIx::Class2/AUTHORS> listed in
...
L<ebbs and flows|https://metacpan.org/changes/distribution/DBIx-Class2>.)
...
See L<DBIx::Class2::ResultSet/create>
...
See L<DBIx::Class2::ResultSet/find>, L<DBIx::Class2::ResultSet/search>, L<DBIx::Class2::ResultSet/next>, and L<DBIx::Class2::ResultSet/all>
...
=item See L<SQL::Abstract::Classic>, L<DBIx::Class2::ResultSet/next>, and L<DBIx::Class2::ResultSet/search>
...
=item L<DBIx::Class2::ResultSet/find_or_create>

=item L<DBIx::Class2::ResultSet/update_or_create>
...
=item L<DBIx::Class2::Relationship/belongs_to>

=item L<DBIx::Class2::Relationship/has_many>

=item L<DBIx::Class2::Relationship/might_have>

=item L<DBIx::Class2::Relationship/has_one>

=item L<DBIx::Class2::Relationship/many_to_many>

=item SET AND FORGET

=back

=head1 DBIx::Class2 Specific Features

These things may be in other ORM's, but they are very specific, so doubtful

=head2 ->deploy

Create a database from your DBIx::Class2 schema.

 my $schema = Frew::Schema->connect( $dsn, $user, $pass );

 $schema->deploy

See L<DBIx::Class2::Schema/deploy>.

See also: L<DBIx::Class2::DeploymentHandler>

=head2 Schema::Loader

Create a DBIx::Class2 schema from your database.
 ...
 use base 'DBIx::Class2::Schema::Loader';
...
See L<DBIx::Class2::Schema::Loader> and L<DBIx::Class2::Schema::Loader::Base/CONSTRUCTOR OPTIONS>.
...
See L<DBIx::Class2::Schema/populate>
...
DBIx::Class2 helped pioneer fast MI in Perl 5 with Class::C3, so it is made to
allow extensions to nearly every part of it.

=head2 Extensibility example: DBIx::Class2::Helpers

=over 1

=item L<DBIx::Class2::Helper::ResultSet::IgnoreWantarray>

=item L<DBIx::Class2::Helper::ResultSet::Random>

=item L<DBIx::Class2::Helper::ResultSet::SetOperations>

=item L<DBIx::Class2::Helper::Row::JoinTable>

=item L<DBIx::Class2::Helper::Row::NumifyGet>

=item L<DBIx::Class2::Helper::Row::SubClass>

=item L<DBIx::Class2::Helper::Row::ToJSON>

=item L<DBIx::Class2::Helper::Row::StorageValues>

=item L<DBIx::Class2::Helper::Row::OnColumnChange>

=back

=head2 Extensibility example: DBIx::Class2::TimeStamp

=over 1

=item See L<DBIx::Class2::TimeStamp>
...
=item See L<DBIx::Class2::Schema::KiokuDB>
...
See L<DBIx::Class2::Manual::Cookbook/Predefined searches>
...
=item L<DBIx::Class2::ResultSet/current_source_alias> helps things to work no matter what
...
See: L<DBIx::Class2::ResultSet/related_resultset>,
L<DBIx::Class2::ResultSet/search_related>, and
L<DBIx::Class2::ResultSet/get_column>.
...
See L<DBIx::Class2::Relationship::Base/create_related> and L<DBIx::Class2::Relationship::Base/add_to_$rel>
...
See L<DBIx::Class2::Schema/txn_do>, L<DBIx::Class2::Schema/txn_begin>,
and L<DBIx::Class2::Schema/txn_commit>.
...
See L<DBIx::Class2::InflateColumn>, L<DBIx::Class2::InflateColumn/inflate_column>, and
...
See L<DBIx::Class2::FilterColumn> and L<DBIx::Class2::FilterColumn/filter_column>
...
See L<DBIx::Class2::ResultSetColumn>
...
See L<DBIx::Class2::ResultSet/select>, L<DBIx::Class2::ResultSet/as>, and
L<DBIx::Class2::ResultSet/group_by>
...
See L<DBIx::Class2::ResultSet/result_class> and L<DBIx::Class2::ResultClass::HashRefInflator>.
...
See L<DBIx::Class2::Manual::Cookbook/Subqueries>
