...
DBIx::Class2::Manual::Reading - How to read and write DBIx::Class2 POD.

=head1 DESCRIPTION

This doc should help users to understand how the examples and
documentation found in the L<DBIx::Class2> distribution can be
interpreted.

Writers of DBIx::Class2 POD should also check here to make sure their
...
For example, L<DBIx::Class2::Relationship> documents the methods
actually coded in the helper relationship classes like
DBIx::Class2::Relationship::BelongsTo. The BelongsTo file itself is
hidden from PAUSE as it has no documentation. The accessors created by
relationships should be mentioned in L<DBIx::Class2::Row>, the major
...
%var - A hashref variable (list of key/value pairs) - rarely used in DBIx::Class2.
...
L<$obj|DBIx::Class2> - Reference to the source class or object definition
...
documentation.  For example:
  ...
  ## Correct, if stated within DBIx::Class2::ResultSet
  L<$resultset|/new>

  ## Correct, if stated outside DBIx::Class2::ResultSet
  L<$resultset|DBIx::Class2::ResultSet>
