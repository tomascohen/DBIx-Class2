...
DBIx::Class2::Manual::Intro - Introduction to DBIx::Class2
...
DBIx::Class2 needs to know what your Table structure looks like.  You
do that by defining Result classes. Result classes are defined by
calling methods proxied to L<DBIx::Class2::ResultSource>.  Each Result
...
be creating a L<DBIx::Class2::ResultSet> from its ResultSource.  For example, the
results of:
...
DBIx::Class2 doesn't limit you to creating only simple ResultSets -- if you
...
The important thing to understand:
  ...
  creating a DBIx::Class2::ResultSet.

=head2 Search is like "prepare"

DBIx::Class2 tends to wait until it absolutely must fetch information from the
...
L<Result|DBIx::Class2::Manual::ResultClass> objects.

=head1 SETTING UP DBIx::Class2

Let's look at how you can set and use your first native L<DBIx::Class2> tree.
...
DBIx::Class2::Schema::Loader>, which shows you how to use
L<DBIx::Class2::Schema::Loader>.

=head2 Setting it up manually

First, you should create your base schema class, which inherits from
L<DBIx::Class2::Schema>:
...
defaulted to be DBIx::Class2::ResultSet objects). You can change the
result and resultset namespaces by using options to the
L<DBIx::Class2::Schema/load_namespaces> call.
...
DBIx::Class2 doesn't directly use most of this data yet, but various related
...
See L<DBIx::Class2::Schema/deploy> for details.

See L<DBIx::Class2::ResultSource> for more details of the possible column
attributes.
...
See L<DBIx::Class2::Relationship> for more information about the various types of
available relationships and how you can design your own.

=head2 Using DBIx::Class2::Schema::Loader

This module (L<DBIx::Class2::Schema::Loader>) is an external module, and not part
of the L<DBIx::Class2> distribution. It inspects your database, and automatically
creates classes for all the tables in your schema.

The simplest way to use it is via the L<dbicdump> script from the
L<DBIx::Class2::Schema::Loader> distribution. For example:
...
See the L<DBIx::Class2::Schema::Loader> and L<DBIx::Class2::Schema::Loader::Base>
...
Note that L<DBIx::Class2::Schema> does not cache connections for you. If you use
...
See L<DBIx::Class2::Storage::DBI/connect_info> for more information about
...
L<DBIx::Class2::Schema::Loader>, you can start interacting with your database.

To access your database using your $schema object, you can fetch a
L<DBIx::Class2::Manual::Glossary/"ResultSet"> representing each of your tables by
...
L<DBIx::Class2> provides a few different ways to retrieve data from your
database.  Here's one example:

  # Find all of Santana's albums
  my $rs = $schema->resultset('Album')->search({ artist => 'Santana' });

In scalar context, as above, C<search> returns a L<DBIx::Class2::ResultSet>
...
For more examples of complex queries, see L<DBIx::Class2::Manual::Cookbook>.
...
For more information on what you can do with a L<DBIx::Class2::ResultSet>, see
L<DBIx::Class2::ResultSet/METHODS>.
...
The concept of a L<primary key|DBIx::Class2::ResultSource/set_primary_key> in
DBIx::Class2 warrants special discussion. The formal definition (which somewhat
...
L<delete|DBIx::Class2::Row/delete>,
L<update|DBIx::Class2::Row/update>,
L<discard_changes|DBIx::Class2::Row/discard_changes>,
etc.) DBIx::Class2 will use the values of the
L<primary key|DBIx::Class2::ResultSource/set_primary_key> columns to populate
the C<WHERE> clause necessary to accomplish the operation. This is why it is
important to declare a L<primary key|DBIx::Class2::ResultSource/set_primary_key>
...
Note that DBIx::Class2 is smart enough to store a copy of the PK values before
any row-object changes take place, so even if you change the values of PK
columns the C<WHERE> clause will remain correct.

If you elect not to declare a C<primary key>, DBIx::Class2 will behave correctly
...
L<DBIx::Class2::ResultSet> CRUD methods:
L<search|DBIx::Class2::ResultSet/search>,
L<update|DBIx::Class2::ResultSet/update>,
L<delete|DBIx::Class2::ResultSet/delete>
...
information on this can be found in L<DBIx::Class2::Manual::Troubleshooting>

=head1 SEE ALSO

=over 4

=item * L<DBIx::Class2::Manual::Cookbook>
