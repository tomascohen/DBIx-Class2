...
DBIx::Class2::Manual::Cookbook - Miscellaneous recipes

=head1 SEARCHING

=head2 Paged results

When you expect a large number of results, you can ask L<DBIx::Class2> for a
...
You can get a L<DBIx::Class2::ResultSet::Pager> object for the resultset
...
can be easily done with L<< $rs->first|DBIx::Class2::ResultSet/first
...
object.  L<< $rs->single|DBIx::Class2::ResultSet/single >> is designed
...
get the results as a L<DBIx::Class2::ResultSet>.

This is accomplished by defining a
L<ResultSource::View|DBIx::Class2::ResultSource::View> for your query,
...
... and you'll get back a perfect L<DBIx::Class2::ResultSet> (except, of course,
that you cannot modify the rows it contains, e.g. cannot call
L<update|DBIx::Class2::ResultSet/update> or
L<delete|DBIx::Class2::ResultSet/delete> on it).
...
L<DBIx::Class2::Schema/deploy>, add this line to your source definition, so that
...
L<DBIx::Class2::ResultSet/ATTRIBUTES>). You can control the C<AS> part of the
...
L<add_columns|DBIx::Class2::ResultSource/add_columns>), you just access it as
...
any of your aliases using either of these:
  ...
  # Or use DBIx::Class2::AccessorGroup:
...
L<DBIx::Class2> supports C<GROUP BY> as follows:
...
Please see L<DBIx::Class2::ResultSet/ATTRIBUTES> documentation if you
...
If you're using L<DBIx::Class2::Schema/load_namespaces>, simply place the file
into the C<ResultSet> directory next to your C<Result> directory, and it will
be automatically loaded.

If however you are still using L<DBIx::Class2::Schema/load_classes>, first tell
DBIx::Class2 to create an instance of the ResultSet class for you, in your
...
it can be accomplished with C<DBIx::Class2> when necessary by resorting to
literal SQL:
...
explained in L<DBIx::Class2::ResultSet/DBIC BIND VALUES>.
...
and L<GenericSubQ|DBIx::Class2::SQLMaker::LimitDialects/GenericSubQ> is either
too slow or does not work at all, you can try the
L<software_limit|DBIx::Class2::ResultSet/software_limit>
L<DBIx::Class2::ResultSet> attribute, which skips over records to simulate limits
in the Perl layer.
...
This requires that you have defined the L<DBIx::Class2::Relationship>. For example :
...
(see L<DBIx::Class2::Manual::Joining> for more details on aliasing ).
...
the artist name for any of the CD objects returned, L<DBIx::Class2> will go back
to the database:
...
Thankfully, L<DBIx::Class2> has a C<prefetch> attribute to solve this problem.
...
L<DBIx::Class2> has now prefetched all matching data from the C<artist> table,
...
=head2 Static sub-classing DBIx::Class2 result classes
...
B<Result-Subclass definition>
    ...
    # otherwise DBIx::Class2::ResultSourceProxy::Table will not be called
...
=head2 Dynamic Sub-classing DBIx::Class2 proxy classes

AKA multi-class object inflation from one table

L<DBIx::Class2> classes are proxy classes, therefore some different
techniques need to be employed for more than basic subclassing.  In
this example we have a single user table that carries a boolean bit
for admin.  We would like to give the admin users
objects (L<DBIx::Class2::Row>) the same methods as a regular user but
...
L<DBIx::Class2::ResultSet> when inflating a result from storage.  So we
...
Alternatively you can use L<DBIx::Class2::DynamicSubclass> that implements
exactly the above functionality.

=head2 Skip result object creation for faster results

DBIx::Class2 is not built for speed, it's built for convenience and
ease of use, but sometimes you just need to get the data, and skip the
fancy objects.

To do this simply use L<DBIx::Class2::ResultClass::HashRefInflator>.
...
L<DBIx::Class2::ResultSet/result_class> will replace any existing class
completely including any special components loaded using
load_components, eg L<DBIx::Class2::InflateColumn::DateTime>.

=head2 Get raw data for blindingly fast results

If the L<HashRefInflator|DBIx::Class2::ResultClass::HashRefInflator> solution
above is not fast enough for you, you can use a DBIx::Class2 to return values
...
use the L<DBIx::Class2::ResultSet/select> attribute of L<DBIx::Class2::ResultSet/search> to force ordering).

=head1 RESULTSET OPERATIONS

=head2 Getting Schema from a ResultSet

To get the L<DBIx::Class2::Schema> object from a ResultSet, do the following:
...
ways, the obvious one is to use search:
  ...
  my $rs = $schema->resultset('Items')->search(
    ...
    {
       select => [ { sum => 'Cost' } ],
       as     => [ 'total_cost' ], # remember this 'as' is for DBIx::Class2::ResultSet not SQL
    }
  );
  my $tc = $rs->first->get_column('total_cost');

Or, you can use the L<DBIx::Class2::ResultSetColumn>, which gets
...
See L<DBIx::Class2::ResultSetColumn> for more documentation.
...
L<set_cache|DBIx::Class2::ResultSet/set_cache> method:
...
This is straightforward using L<ManyToMany|DBIx::Class2::Relationship/many_to_many>:
...
Mapping relationships across L<DB schemas|DBIx::Class2::Manual::Glossary/DB schema>
...
L<connection|DBIx::Class2::Schema/connection> method in your Schema class and
building a renaming facility, like so:

  package MyApp::Schema;
  use Moose;

  extends 'DBIx::Class2::Schema';
...
By overriding the L<connection|DBIx::Class2::Schema/connection>
...
L<connection|DBIx::Class2::Schema/connect>, as follows:
...
L<DBIx::Class2::Storage> and L<DBIx::Class2::Schema>.  Here is an
...
L<txn_do|DBIx::Class2::Storage/txn_do>: If the L<try|Try::Tiny/try>-block
around L<txn_do|DBIx::Class2::Storage/txn_do> fails, a rollback is issued.
...
=head2 Simple Transactions with DBIx::Class2::Storage::TxnScopeGuard

An easy way to use transactions is with
L<DBIx::Class2::Storage::TxnScopeGuard>. See L</Automatically creating
...
L<DBIx::Class2::Schema::Loader> will connect to a database and create a
L<DBIx::Class2::Schema> and associated sources by examining the database.

The recommend way of achieving this is to use the L<dbicdump> utility or the
L<Catalyst> helper, as described in
L<Manual::Intro|DBIx::Class2::Manual::Intro/Using DBIx::Class2::Schema::Loader>.

Alternatively, use the
L<make_schema_at|DBIx::Class2::Schema::Loader/make_schema_at> method:

  perl -MDBIx::Class2::Schema::Loader=make_schema_at,dump_to_dir:./lib \
...
In case you're going to use this "trick" together with L<DBIx::Class2::Schema/deploy> or
L<DBIx::Class2::Schema/create_ddl_dir> a table called "dual" will be created in your
...
Or use L<DBIx::Class2::ResultClass::HashRefInflator>
...
L<callback system|DBIx::Class2::ResultSource/sqlt_deploy_callback> if you wish
...
The following example shows simplistically how you might use DBIx::Class2 to
...
Call L<DBIx::Class2::Schema/create_ddl_dir> as above under L</Creating DDL SQL>.
...
DBIx::Class2, export the modified schema and the conversion scripts as
in L</Creating DDL SQL>.

B<Deploy update to customers>

Add the L<DBIx::Class2::Schema::Versioned> schema component to your
...
L<DBIx::Class2::ResultSet/create> and L<DBIx::Class2::Row/update> family of
methods:
...
In conditions (e.g. C<\%cond> in the L<DBIx::Class2::ResultSet/search> family of
...
formatter returned by L<DBIx::Class2::Storage::DBI/datetime_parser> to format
any L<DateTime> objects you pass to L<search|DBIx::Class2::ResultSet/search>
conditions. Any L<Storage|DBIx::Class2::Storage> object attached to your
L<Schema|DBIx::Class2::Schema> provides a correct L<DateTime> formatter, so
...
L<search|DBIx::Class2::ResultSet/search> and L<DBIx::Class2::ResultSet/find>,
whereas L<create|DBIx::Class2::ResultSet/create> and
L<DBIx::Class2::Row/update> (but not L<DBIx::Class2::ResultSet/update>) are
L<DBIx::Class2::InflateColumn>-aware and will do the right thing when supplied
...
The L<DBIx::Class2::UTF8Columns> component handles storing selected
...
You want to start using the schema-based approach to L<DBIx::Class2>
(see L<DBIx::Class2::Manual::Intro/Setting it up manually>), but have an
...
want to move by hand. Try this nifty script instead:
  ...
  $translator->producer('SQL::Translator::Producer::DBIx::Class2::File');
...
L<DBIx::Class2> uses the L<Class::C3> package, which provides for redispatch of
...
L<Class::C3> with L<DBIx::Class2> can be found in
L<DBIx::Class2::Manual::Component>.
...
documentation. See also L<DBIx::Class2::Manual::Component> for more
ways to write your own base classes to do this.

People looking for ways to do "triggers" with DBIx::Class2 are probably
...
=head2 DBIx::Class2 objects with Data::Dumper
...
When you enable L<DBIx::Class2::Storage>'s debugging it prints the SQL
executed as well as notifications of query completion and transaction
begin/commit.  If you'd like to profile the SQL you can subclass the
L<DBIx::Class2::Storage::Statistics> class and write your own profiling
mechanism:
...
You might want to check out L<DBIx::Class2::QueryLog> as well.
...
L<prefetch|DBIx::Class2::ResultSet/prefetch> relationships, where possible. See
L</Using joins and prefetch>.

=item *

Use L<populate|DBIx::Class2::ResultSet/populate> in void context to insert data
when you don't need the resulting L<result|DBIx::Class2::Manual::ResultClass> objects,
...
If using L<create|DBIx::Class2::ResultSet/create> instead, use a transaction and
commit every C<X> rows; where C<X> gives you the best performance without
locking the table for too long.

=item *

When selecting many rows, if you don't need full-blown L<DBIx::Class2::Row>
objects, consider using L<DBIx::Class2::ResultClass::HashRefInflator>.
...
L<DBIx::Class2|DBIx::Class2> programs can have a significant startup delay
...
If you are using
L<DBIx::Class2::Schema::Loader|DBIx::Class2::Schema::Loader> to build the
...
using L<DBIx::Class2::Schema::Loader> to dump the database schema once - see
L<make_schema_at|DBIx::Class2::Schema::Loader/make_schema_at> and
L<dump_directory|DBIx::Class2::Schema::Loader::Base/dump_directory> for more
details on creating static schemas from a database).

=head2 Move Common Startup into a Base Class

Typically L<DBIx::Class2> result classes start off with
...
If you are instead using the L<load_namespaces|DBIx::Class2::Schema/load_namespaces>
...
L<DBIx::Class2> normally caches all statements with
