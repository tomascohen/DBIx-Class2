...
DBIx::Class2::Manual::Example - Simple CD database example

=head1 DESCRIPTION

This tutorial will guide you through the process of setting up and
testing a very basic CD database using SQLite, with DBIx::Class2::Schema
...
You'll need to install DBIx::Class2 via CPAN, and you'll also need to
...
This example uses L<DBIx::Class2::Schema/load_namespaces> to load in the
appropriate L<Result|DBIx::Class2::Manual::ResultClass> classes from the
C<MyApp::Schema::Result> namespace, and any required
L<ResultSet|DBIx::Class2::ResultSet> classes from the
