...
DBIx::Class2::Manual::Joining - Manual on joining tables with DBIx::Class2

=head1 DESCRIPTION

This document should help you to use L<DBIx::Class2> if you are trying
to convert your normal SQL queries into DBIx::Class2 based queries, if
...
then you should likely try the L<DBIx::Class2::Manual::Intro>
...
In L<DBIx::Class2> each relationship between two tables needs to first
be defined in the L<ResultSource|DBIx::Class2::Manual::Glossary/ResultSource> for the
...
comprehensively described in L<DBIx::Class2::Relationship>.
...
L<DBIx::Class2::Relationship> docs.

When performing either a L<search|DBIx::Class2::ResultSet/search> or a
L<find|DBIx::Class2::ResultSet/find> operation, you can specify which
C<relations> to also refine your results based on, using the
L<join|DBIx::Class2::ResultSet/join> attribute, like this:
...
read L<DBIx::Class2::ResultSet/search> and
L<DBIx::Class2::ResultSet/ATTRIBUTES>, but here's a quick break down:
...
output, see the L<DBIx::Class2::Manual::FAQ> for an explanation.
...
As an aside to all the discussion on joins, note that L<DBIx::Class2>
