...
DBIx::Class2::Manual::Glossary - Clarification of terms used.

=head1 INTRODUCTION

This document lists various terms used in DBIx::Class2 and attempts to
explain them.

=head1 DBIx::Class2 TERMS
...
language-space. DBIx::Class2 result classes can be set up to inflate
your data into perl objects which more usefully represent their
contents. For example: L<DBIx::Class2::InflateColumn::DateTime> for
datetime or timestamp column data.

See also L<DBIx::Class2::InflateColumn>.

=head2 Deflation

The opposite of L</Inflation>. Existing perl objects that represent
column values can be passed to DBIx::Class2 methods to store into the
database. For example a L<DateTime> object can be automatically
deflated into a datetime string for insertion.

See L<DBIx::Class2::InflateColumn> and other modules in that namespace.
...
to objects in programming-language-space. DBIx::Class2 is an ORM.

=head2 Relationship

In DBIx::Class2 a relationship defines the connection between exactly
...
At least one L<DBIx::Class2::Schema> class is needed per database.
...
in your application, they should inherit from L<DBIx::Class2::Core>.

See also: L<DBIx::Class2::Manual::ResultClass>
...
See also: L<DBIx::Class2::ResultSource/METHODS>
...
See also: L<DBIx::Class2::ResultSet/METHODS>
...
can be found in L<the FAQ|DBIx::Class2::Manual::FAQ>.
