package DBIx::Class2::Relationship::Base;
...
DBIx::Class2::Relationship::Base - Inter-table relationships
...
methods, for predefined ones, look in L<DBIx::Class2::Relationship>.
...
L<DBIx::Class2::ResultSet/search>. The return value will be passed directly to
L<DBIx::Class2::SQLMaker> and the resulting SQL will be used verbatim as the
...
into hashref form by calling L<get_columns|DBIx::Class2::Row/get_columns>.
...
L<< $result->create_related|DBIx::Class2::Relationship::Base/create_related >>),
...
The L<standard ResultSet attributes|DBIx::Class2::ResultSet/ATTRIBUTES> may
...
By default, DBIx::Class2 cascades deletes across C<has_many>,
...
before DBIx::Class2 gets to perform the cascaded operation.

=item cascade_update

By default, DBIx::Class2 cascades updates across C<has_one> and
...
specified globally in the args to L<DBIx::Class2::Schema/deploy> or
L<DBIx::Class2::Schema/create_ddl_dir>. Default is on, set to 0 to disable.
...
DBIx::Class2::ResultSourceProxy to set up Accessors and Proxies.
...
=item Return Value: L<$related_resultset|DBIx::Class2::ResultSet>

=back

  $rs = $cd->related_resultset('artist');

Returns a L<DBIx::Class2::ResultSet> for the relationship named
$rel_name.
...
=item Return Value: L<$result|DBIx::Class2::Manual::ResultClass> | L<$related_resultset|DBIx::Class2::ResultSet> | undef
...
This will return either a L<Result|DBIx::Class2::Manual::ResultClass> or a
L<ResultSet|DBIx::Class2::ResultSet>, depending on if the relationship is
...
=item Arguments: $rel_name, $cond?, L<\%attrs?|DBIx::Class2::ResultSet/ATTRIBUTES>

=item Return Value: L<$resultset|DBIx::Class2::ResultSet> (scalar context) | L<@result_objs|DBIx::Class2::Manual::ResultClass> (list context)

=back

Run a search on a related resultset. The search will be restricted to the
results represented by the L<DBIx::Class2::ResultSet> it was called
upon.

See L<DBIx::Class2::ResultSet/search_related> for more information.
...
your storage until you call L<DBIx::Class2::Row/insert> on it.
...
and C<new> in L<DBIx::Class2::ResultSet> for details.
...
=item Arguments: $rel_name, \%col_data | @pk_values, { key => $unique_constraint, L<%attrs|DBIx::Class2::ResultSet/ATTRIBUTES> }?
...
See L<DBIx::Class2::ResultSet/find> for details.
...
=item Arguments: $rel_name, \%col_data, { key => $unique_constraint, L<%attrs|DBIx::Class2::ResultSet/ATTRIBUTES> }?

=item Return Value: L<$result|DBIx::Class2::Manual::ResultClass>

=back

Find a result object of a related class.  See L<DBIx::Class2::ResultSet/find_or_new>
for details.
...
L<DBIx::Class2::ResultSet/find_or_create> for details.
...
L<DBIx::Class2::ResultSet/update_or_create> for details.
...
=item Arguments: $rel_name, L<$result|DBIx::Class2::Manual::ResultClass>
...
L<DBIx::Class2::ResultSet/create>, or pass an object to a belongs_to accessor.

The columns are only set in the local copy of the object, call
L<update|DBIx::Class2::Row/update> to update them in the storage.
...
=item Arguments: (\%col_data | L<$result|DBIx::Class2::Manual::ResultClass>), \%link_col_data?
...
See L<DBIx::Class2::Relationship/many_to_many> for additional details.
...
=item Arguments: (\@hashrefs_of_col_data | L<\@result_objs|DBIx::Class2::Manual::ResultClass>), $link_vals?
...
=item Arguments: L<$result|DBIx::Class2::Manual::ResultClass>
