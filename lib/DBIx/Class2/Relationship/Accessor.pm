package # hide from PAUSE
    DBIx::Class2::Relationship::Accessor;
...
our %_pod_inherit_config =
  (
   class_map => { 'DBIx::Class2::Relationship::Accessor' => 'DBIx::Class2::Relationship' }
  );
      ...
      if (@_) {
        ...
        return undef if (
          $relcond->{join_free_condition}
            and
          $relcond->{join_free_condition} ne DBIx::Class2::_Util::UNRESOLVABLE_CONDITION
            and
...
EOC
    ...
    quote_sub "${class}::${rel}", sprintf( <<'EOC', perlstring $rel );
      DBIx::Class2::_ENV_::ASSERT_NO_INTERNAL_WANTARRAY and my $sog = DBIx::Class2::_Util::fail_on_internal_wantarray;
