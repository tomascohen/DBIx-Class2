package # hide from PAUSE
    DBIx::Class2::CDBICompat::ColumnGroups;
...
sub __grouper {
  ...
  return bless($grouper, 'DBIx::Class2::CDBICompat::ColumnGroups::GrouperShim');
}
...
package # hide from PAUSE (should be harmless, no POD no Version)
    DBIx::Class2::CDBICompat::ColumnGroups::GrouperShim;
