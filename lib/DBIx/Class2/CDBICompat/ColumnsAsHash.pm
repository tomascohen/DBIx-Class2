package
    DBIx::Class2::CDBICompat::ColumnsAsHash;
...
DBIx::Class2::CDBICompat::ColumnsAsHash - Emulates the behavior of Class::DBI where the object can be accessed as a hash of columns.
...
sub _make_columns_as_hash {
    ...
    for my $col ($self->columns) {
        ...
        tie $self->{$col}, 'DBIx::Class2::CDBICompat::Tied::ColumnValue',
            $self, $col;
    }
}


package DBIx::Class2::CDBICompat::Tied::ColumnValue;
