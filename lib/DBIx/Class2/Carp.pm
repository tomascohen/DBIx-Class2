...
# Need a way to parameterize this for Carp::Skip
      $1 !~ /^(?: DBIx::Class2::Storage::BlockRunner | Context::Preserve | Try::Tiny | Class::Accessor::Grouped | Class::C3::Componentised | Module::Runtime )$/x
        and
...
DBIx::Class2::Carp - Provides advanced Carp::Clan-like warning functions for DBIx::Class2 internals
...
In addition to the classic interface:
  ...
  use DBIx::Class2::Carp '^DBIx::Class2'
...
L<DBIx::Class2::Schema/throw_exception> or L<DBIx::Class2::Exception>.
