package DBIx::Class2::PK;

use strict;
use warnings;

use base qw/DBIx::Class2::Row/;

=head1 NAME

DBIx::Class2::PK - Primary Key class
...
Used by L<DBIx::Class2::CDBICompat::LiveObjectIndex> and
L<DBIx::Class2::ObjectCache>.
...
to L<DBIx::Class2::ResultSource/set_primary_key>.
