package DBIx::Class2::ResultSet;

use strict;
use warnings;
use base qw/DBIx::Class2/;
use DBIx::Class2::Carp;
use DBIx::Class2::ResultSetColumn;
use Scalar::Util qw/blessed weaken reftype/;
use DBIx::Class2::_Util qw(
...
DBIx::Class2::ResultSet - Represents a query used for fetching a set of results.
...
a query. It is the backbone of DBIx::Class2 (i.e. the really
...
by calling C<resultset> on a L<DBIx::Class2::Schema> and passing in a
L<Source|DBIx::Class2::Manual::Glossary/ResultSource> name.
...
can be used to walk through all the L<DBIx::Class2::Row>s the ResultSet
represents.
...
To add methods to your resultsets, you can subclass L<DBIx::Class2::ResultSet>, similar to:
...
See L<DBIx::Class2::Schema/load_namespaces> on how DBIC can discover and
automatically attach L<Result|DBIx::Class2::Manual::ResultClass>-specific
L<ResulSet|DBIx::Class2::ResultSet> classes.
...
|DBIx::Class2::ResultSet/new> C<< ->new($source, \%args) >>.

  use Moo;
  extends 'DBIx::Class2::ResultSet';
...
=item Arguments: L<$source|DBIx::Class2::ResultSource>, L<\%attrs?|/ATTRIBUTES>
...
L<DBIx::Class2::ResultSourceProxy::Table>) and an attribute hash (see
...
from e.g. a
C<< $schema->L<resultset|DBIx::Class2::Schema/resultset>('$source_name') >>
...
sub new {
  ...
  if (ref $class) {
    DBIx::Class2::_ENV_::ASSERT_NO_INTERNAL_INDIRECT_CALLS and fail_on_internal_call;
    return $class->new_result(@_);
  }

  my ($source, $attrs) = @_;
  $source = $source->resolve
    if $source->isa('DBIx::Class2::ResultSourceHandle');
...
=item Arguments: L<$cond|DBIx::Class2::SQLMaker> | undef, L<\%attrs?|/ATTRIBUTES>

=item Return Value: $resultset (scalar context) | L<@result_objs|DBIx::Class2::Manual::ResultClass> (list context)
...
returning a list of L<result|DBIx::Class2::Manual::ResultClass> objects instead.
...
L<Searching|DBIx::Class2::Manual::Cookbook/SEARCHING>. For a complete
documentation for the first argument, see
L<SQL::Abstract::Classic/"WHERE CLAUSES"> and its extension
L<DBIx::Class2::SQLMaker>.

For more help on using joins with search, see L<DBIx::Class2::Manual::Joining>.
...
L<DBIx::Class2::Manual::Cookbook/Formatting DateTime objects in queries>.
...
sub search {
  ...
  if (wantarray) {
    DBIx::Class2::_ENV_::ASSERT_NO_INTERNAL_WANTARRAY and my $sog = fail_on_internal_wantarray;
    return $rs->all;
  }
...
=item Arguments: L<$cond|DBIx::Class2::SQLMaker>, L<\%attrs?|/ATTRIBUTES>
...
sub search_rs {
  ...
  # legacy search
    ...
    carp_unique 'search( %condition ) is deprecated, use search( \%condition ) instead'
      unless $rsrc->result_class->isa('DBIx::Class2::CDBICompat');
...
See L<DBIx::Class2::Manual::Cookbook/SEARCHING> and
L<DBIx::Class2::Manual::FAQ/Searching> for searching techniques that do not
...
=item Return Value: L<$resultset|/search> (scalar context) | L<@result_objs|DBIx::Class2::Manual::ResultClass> (list context)
...
=item Return Value: L<$result|DBIx::Class2::Manual::ResultClass> | undef
...
order as the L<primary columns|DBIx::Class2::ResultSource/primary_columns>
...
L<unique constraint|DBIx::Class2::ResultSource/add_unique_constraint> (the
unique constraint corresponding to the
L<primary columns|DBIx::Class2::ResultSource/primary_columns> is always named
...
# DBIx::Class2::ResultSet->can('_non_unique_find_fallback') is reasonable
#
...
=item Return Value: L<$cursor|DBIx::Class2::Cursor>

=back

Returns a storage-driven cursor to the given resultset. See
L<DBIx::Class2::Cursor> for more information.
...
=item Arguments: L<$cond?|DBIx::Class2::SQLMaker>
...
L<DBIx::Class2::ResultSet> returned.
...
=item Return Value: L<$resultsetcolumn|DBIx::Class2::ResultSetColumn>

=back

  my $max_length = $rs->get_column('length')->max;

Returns a L<DBIx::Class2::ResultSetColumn> instance for a column of the ResultSet.

=cut

sub get_column {
  my ($self, $column) = @_;
  my $new = DBIx::Class2::ResultSetColumn->new($self, $column);
  return $new;
}
...
For more information, see L<DBIx::Class2::Manual::Cookbook>.
...
sub _construct_results {
  ...
  $self->{_result_inflator}{is_core_row} = ( (
    $inflator_cref
      ==
    ( \&DBIx::Class2::Row::inflate_result || die "No ::Row::inflate_result() - can't happen" )
  ...
  $self->{_result_inflator}{is_hri} = ( (
    ! $self->{_result_inflator}{is_core_row}
      and
    $inflator_cref == (
      require DBIx::Class2::ResultClass::HashRefInflator
        &&
      DBIx::Class2::ResultClass::HashRefInflator->can('inflate_result')
    )
...
=item Arguments: L<$result_source?|DBIx::Class2::ResultSource>

=item Return Value: L<$result_source|DBIx::Class2::ResultSource>
...
L<"table"|DBIx::Class2::Manual::Glossary/"ResultSource"> class.
...
=item Return Value: L<$count_rs|DBIx::Class2::ResultSetColumn>

=back

Same as L</count> but returns a L<DBIx::Class2::ResultSetColumn> object.
...
=item Return Value: L<@result_objs|DBIx::Class2::Manual::ResultClass>
...
L<result component|DBIx::Class2::Manual::Component/WHAT IS A COMPONENT>.
...
This is unlike the corresponding L<DBIx::Class2::Row/update>. The user must
...
L<DBIx::Class2::Row/update>. Note that C<update_all> will run DBIC defined
...
L<in_storage|DBIx::Class2::Row/in_storage> status of any result object instances
...
L<DBIx::Class2::Row/delete>. Note that C<delete_all> will run DBIC defined
...
=item Return Value: L<\@result_objects|DBIx::Class2::Manual::ResultClass> (scalar context) | L<@result_objects|DBIx::Class2::Manual::ResultClass> (list context)
...
L<DBI/execute_for_fetch>), bypassing the L<new|DBIx::Class2::Row/new> and
L<insert|DBIx::Class2::Row/insert> calls on the
L<Result|DBIx::Class2::Manual::ResultClass> class, including any
augmentation of these methods provided by components. For example if you
are using something like L<DBIx::Class2::UUIDColumns> to create primary
...
L<Result|DBIx::Class2::Manual::ResultClass> objects or an arrayref
          ...
          if ($_->{is_rel} ||= (
            ...
            (
              ...
              ref $data->[$i][$_->{pos}] eq 'HASH'
                or
              ( defined blessed $data->[$i][$_->{pos}] and $data->[$i][$_->{pos}]->isa('DBIx::Class2::Row') )
            )
              and
            1
          )) {
            ...
            for ( ref $data->[$i][$_->{pos}] eq 'ARRAY' ? @{$data->[$i][$_->{pos}]} : $data->[$i][$_->{pos}] ) {
              if ( defined blessed $_ and $_->isa('DBIx::Class2::Row' ) ) {
        ...
        if ($colinfo->{$_}{is_rel} ||= (
          ...
          (
            ...
            ref $data->[$i]{$_} eq 'HASH'
              or
            ( defined blessed $data->[$i]{$_} and $data->[$i]{$_}->isa('DBIx::Class2::Row') )
          )
            and
          1
        )) {
...
=item Return Value: L<$pager|DBIx::Class2::ResultSet::Pager>

=back

Returns a L<DBIx::Class2::ResultSet::Pager> object tied to the current
...
L<total_entries|DBIx::Class2::ResultSet::Pager/total_entries> on the pager
object.
...
sub pager {
  ...
  require DBIx::Class2::ResultSet::Pager;
  return $self->{pager} = DBIx::Class2::ResultSet::Pager->new(
...
=item Return Value: L<$result|DBIx::Class2::Manual::ResultClass>
...
L<DBIx::Class2::Row/insert> to do that. Calling L<DBIx::Class2::Row/in_storage>
will tell you whether the result object has been inserted or not.

Passes the hashref of input on to L<DBIx::Class2::Row/new>.
...
into your storage until you call L<DBIx::Class2::Row/insert> on it.
...
(L<DBIx::Class2::Relationship/has_many>) - pass an arrayref of hashrefs.
...
bypassed more often than not. Override either L<DBIx::Class2::Row/new>
or L<DBIx::Class2::Row/insert> depending on how early in the
...
unique constraints, see L<DBIx::Class2::ResultSource/add_unique_constraint>.

If you need to know if an existing row was found or a new one created use
L</find_or_new> and L<DBIx::Class2::Row/in_storage> instead. Don't forget
to call L<DBIx::Class2::Row/insert> to save the newly created row to the
database!
...
L</update_or_new> and L<DBIx::Class2::Row/in_storage> instead. Don't forget
to call L<DBIx::Class2::Row/insert> to save the newly created row to the
database!
...
=item Return Value: L<\@result_objs|DBIx::Class2::Manual::ResultClass> | undef
...
=item Arguments: L<\@result_objs|DBIx::Class2::Manual::ResultClass>
...
term goal is to make L<DBIx::Class2> always alias the current resultset as C<me>
(and make this method unnecessary).

Thus it's currently necessary to use this method in predefined queries (see
L<DBIx::Class2::Manual::Cookbook/Predefined searches>) when referring to the
...
See L<DBIx::Class2::Schema/throw_exception> for details.
...
L<DBIx::Class2::ResultSource/resultset_attributes>.  (Please read
...
use L</select>, to instruct DBIx::Class2 how to store the result of the column.
...
L<Row|DBIx::Class2::Row> object. The value will then be accessible via this
...
L<DBIx::Class2::Manual::Cookbook> for details.
...
L<Sybase ASE|DBIx::Class2::Storage::DBI::Sybase::ASE> using the
L<Generic Sub Query|DBIx::Class2::SQLMaker::LimitDialects/GenericSubQ> hack)
...
L<DBIx::Class2::ResultSetColumn> (L</get_column>). A notable exception are the
...
DBIx::Class2 supports arbitrary related data prefetching from multiple related
...
L<DBIx::Class2> has no need to go back to the database when we access the
...
condition|DBIx::Class2::Relationship::Base/condition>
...
"data_type" from the L<add_columns column info|DBIx::Class2::ResultSource/add_columns>.
...
Defaults to "size" from the L<add_columns column info|DBIx::Class2::ResultSource/add_columns>,
