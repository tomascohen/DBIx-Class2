...

{
  package # Hide from PAUSE
    DBIx::Class2::Storage::NESTED_ROLLBACK_EXCEPTION;
  use base 'DBIx::Class2::Exception';
}

use DBIx::Class2::Carp;
use DBIx::Class2::Storage::BlockRunner;
use Scalar::Util qw/blessed weaken/;
use DBIx::Class2::Storage::TxnScopeGuard;
use Try::Tiny;
use namespace::clean;
...
__PACKAGE__->cursor_class('DBIx::Class2::Cursor');

sub cursor { shift->cursor_class(@_); }

=head1 NAME

DBIx::Class2::Storage - Generic Storage Handler

=head1 DESCRIPTION

A base implementation of common Storage methods.  For specific
information about L<DBI>-based storage, see L<DBIx::Class2::Storage::DBI>.
...
storage object, such as during L<DBIx::Class2::Schema/clone>.
...
Please note that all of the code in your coderef, including non-DBIx::Class2
...
It does I<not> perform an actual storage commit unless there's a DBIx::Class2
...
throw a L<DBIx::Class2::Storage::NESTED_ROLLBACK_EXCEPTION> exception,
...
sub txn_rollback {
  ...
  if ($self->transaction_depth == 1) {
    ...
    if ($self->auto_savepoint) {
      ...
      DBIx::Class2::Storage::NESTED_ROLLBACK_EXCEPTION->throw(
...
L<DBIx::Class2::Storage::TxnScopeGuard>:
...
sub txn_scope_guard {
  return DBIx::Class2::Storage::TxnScopeGuard->new($_[0]);
}

=head2 sql_maker

Returns a C<sql_maker> object - normally an object of class
C<DBIx::Class2::SQLMaker>.
...
|DBIx::Class2::Storage::Statistics/debugfh >>
...
of L<DBIx::Class2::Storage::Statistics> that is compatible with the original
...
sub debugobj {
  ...
  $self->{debugobj} ||= do {
    if (my $profile = $ENV{DBIC_TRACE_PROFILE}) {
      require DBIx::Class2::Storage::Debug::PrettyTrace;
      my @pp_args;
      ...
      # DBIx::Class2::Storage::Debug::PrettyTrace takes place
      ...
      try {
        DBIx::Class2::Storage::Debug::PrettyTrace->new(@pp_args);
      } catch {
      ...
      DBIx::Class2::Storage::Statistics->new
    }
  };
}
...
This is normally accessed via L<DBIx::Class2::Schema/connection>, which
...
If C<DBIC_TRACE_PROFILE> is set, L<DBIx::Class2::Storage::Debug::PrettyTrace>
...
L<DBIx::Class2::Storage::DBI> - reference storage implementation using
