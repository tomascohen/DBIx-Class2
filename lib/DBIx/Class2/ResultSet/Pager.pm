package DBIx::Class2::ResultSet::Pager;
...
sub entries_per_page {
  ...
  DBIx::Class2::Exception->throw( "Fewer than one entry per page!" )
    if $_[0] < 1;
...
DBIx::Class2::ResultSet::Pager - help when paging through sets of results

=head1 SYNOPSIS

  use DBIx::Class2::ResultSet::Pager;

  my $page = DBIx::Class2::ResultSet::Pager->new();
...
L<DBIx::Class2::ResultSet::Pager>. This module passes the entire contemporary
...
entries per page. It also optionally takes the current page number:
  ...
  my $page = DBIx::Class2::ResultSet::Pager->new($total_entries, $entries_per_page, $current_page);
