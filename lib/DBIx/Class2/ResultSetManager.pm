package DBIx::Class2::ResultSetManager;
use strict;
use warnings;
...
warn "DBIx::Class2::ResultSetManager never left experimental status and
...
DBIx::Class2::Schema->load_classes() to load_namespaces() and creating
appropriate My::Schema::ResultSet::* classes for it to pick up.";

=head1 NAME

DBIx::Class2::ResultSetManager - scheduled for deletion in 09000

=head1 DESCRIPTION

DBIx::Class2::ResultSetManager never left experimental status and
has now been DEPRECATED. This module will be deleted in 09000 so please
migrate any and all code using it to explicit resultset classes using either
__PACKAGE__->resultset_class(...) calls or by switching from using
DBIx::Class2::Schema->load_classes() to load_namespaces() and creating
...
__PACKAGE__->base_resultset_class('DBIx::Class2::ResultSet');
