package DBIx::Class2::ResultSourceProxy::Table;

use strict;
use warnings;

use base qw/DBIx::Class2::ResultSourceProxy/;

use DBIx::Class2::ResultSource::Table;
use Scalar::Util 'blessed';
use namespace::clean;

__PACKAGE__->mk_classdata(table_class => 'DBIx::Class2::ResultSource::Table');
...
DBIx::Class2::ResultSourceProxy::Table - provides a classdata table
...
=head2 table_class
  ...
  __PACKAGE__->table_class('DBIx::Class2::ResultSource::Table');
...
L<DBIx::Class2::ResultSource/add_column>
