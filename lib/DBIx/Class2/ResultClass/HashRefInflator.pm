package DBIx::Class2::ResultClass::HashRefInflator;
...
DBIx::Class2::ResultClass::HashRefInflator - Get raw hashrefs from a resultset

=head1 SYNOPSIS

 use DBIx::Class2::ResultClass::HashRefInflator;

 my $rs = $schema->resultset('CD');
 $rs->result_class('DBIx::Class2::ResultClass::HashRefInflator');
...
DBIx::Class2 is faster than older ORMs like Class::DBI but it still isn't
...
$mk_hash = sub {
  ...
  my $hash = {
    ...
    map { $_ => (
      ...
      # null-branch or not
      ref $_[1]->{$_} eq $DBIx::Class2::ResultSource::RowParser::Util::null_branch_class
...
Inflates the result and prefetched data into a hash-ref (invoked by L<DBIx::Class2::ResultSet>)
...
following:
 ...
 my $cds = $artist->cds;
 $cds->result_class('DBIx::Class2::ResultClass::HashRefInflator');
 my $first = $cds->first;
...
L<DBIx::Class2::InflateColumn::DateTime>, is not performed.
