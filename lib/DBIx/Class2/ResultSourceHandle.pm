package DBIx::Class2::ResultSourceHandle;
...
DBIx::Class2::ResultSourceHandle - Serializable pointers to ResultSource instances

=head1 DESCRIPTION

Currently instances of this class are used to allow proper serialization of
L<ResultSources|DBIx::Class2::ResultSource> (which may contain unserializable
elements like C<CODE> references).

Originally this module was used to remove the fixed link between
L<Rows|DBIx::Class2::Row>/L<ResultSets|DBIx::Class2::ResultSet> and the actual
L<result source objects|DBIx::Class2::ResultSource> in order to obviate the need
of keeping a L<schema instance|DBIx::Class2::Schema> constantly in scope, while
...
sub resolve {
  ...
  $_[0]->_detached_source || DBIx::Class2::Exception->throw( sprintf (
