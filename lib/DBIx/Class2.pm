...

{
  ...
  require constant;
  constant->import( DEVREL => ( ($DBIx::Class2::VERSION =~ /_/) ? 1 : 0 ) );
}
...
use base qw/DBIx::Class2::Componentised DBIx::Class2::AccessorGroup/;
use DBIx::Class2::StartupCheck;
use DBIx::Class2::Exception;

__PACKAGE__->mk_group_accessors(inherited => '_skip_namespace_frames');
__PACKAGE__->_skip_namespace_frames('^DBIx::Class2|^SQL::Abstract|^Try::Tiny|^Class::Accessor::Grouped|^Context::Preserve');
...
sub DESTROY { &DBIx::Class2::_Util::detected_reinvoked_destructor }
...
sub component_base_class { 'DBIx::Class2' }
...
sub DBIx::Class2::_ENV_::HELP_URL () {
  'http://p3rl.org/DBIx::Class2#GETTING_HELP/SUPPORT'
}
...
DBIx::Class2 - Extensible and flexible object <-> relational mapper.

=head1 WHERE TO START READING

See L<DBIx::Class2::Manual::DocMap> for an overview of the exhaustive documentation.
To get the most out of DBIx::Class2 with the least confusion it is strongly
recommended to read (at the very least) the
L<Manuals|DBIx::Class2::Manual::DocMap/Manuals> in the order presented there.

=cut

=head1 GETTING HELP/SUPPORT

Due to the sheer size of its problem domain, DBIx::Class2 is a relatively
complex framework. After you start using DBIx::Class2 questions will inevitably
...
=item * RT Bug Tracker: L<https://rt.cpan.org/Public/Dist/Display.html?Name=DBIx-Class2>

=item * Email: L<mailto:bug-DBIx-Class2@rt.cpan.org>
...
For the very impatient: L<DBIx::Class2::Manual::QuickStart>

This code in the next step can be generated automatically from an existing
database, see L<dbicdump> from the distribution C<DBIx-Class2-Schema-Loader>.
...
See L<DBIx::Class2::ResultSource> for docs on defining result classes.
...
Then you can use these classes in your application's code:
  ...
  # $schema->resultset returns a DBIx::Class2::ResultSet
  my @all_artists = $schema->resultset('Artist')->all;
  my $all_artists_rs = $schema->resultset('Artist');

  # Output all artists names
  # $artist here is a DBIx::Class2::Row, which has accessors
...
DBIx::Class2 can handle multi-column primary and foreign keys, complex
...
APIs, since DBIx::Class2 is used in production in many organisations,
...
=item * Current git repository: L<https://github.com/Perl5/DBIx-Class2>

=item * Travis-CI log: L<https://travis-ci.com/github/Perl5/DBIx-Class2/branches>
...
Copyright (c) 2005 by mst, castaway, ribasushi, and other DBIx::Class2
