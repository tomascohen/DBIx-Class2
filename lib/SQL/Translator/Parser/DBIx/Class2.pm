package SQL::Translator::Parser::DBIx::Class2;
...
use DBIx::Class2::Carp qw/^SQL::Translator|^DBIx::Class2|^Try::Tiny/;
...
# We're working with DBIx::Class2 Schemas, not data streams.
# -------------------------------------------------------------------
sub parse {
    my ($tr, $data)   = @_;
    ...
    for (qw(DBIx::Class2::Schema DBIx::Schema package)) {
    ...
    DBIx::Class2::Exception->throw('No DBIx::Class2::Schema') unless ($dbicschema);

    if (!ref $dbicschema) {
      eval "require $dbicschema"
        or DBIx::Class2::Exception->throw("Can't load $dbicschema: $@");
    }
    ...
    for my $moniker (@monikers){
      my $source = $dbicschema->source($moniker);
       if ( $source->isa('DBIx::Class2::ResultSource::Table') ) {
         $table_monikers{$moniker}++;
      } elsif( $source->isa('DBIx::Class2::ResultSource::View') ){
...
"Arbitrary SQL through a custom ResultSource" in DBIx::Class2::Manual::Cookbook
or http://search.cpan.org/dist/DBIx-Class2/lib/DBIx/Class/Manual/Cookbook.pod
...
sub _resolve_deps {
    ...
    if ( blessed($question)
        && $question->isa('DBIx::Class2::ResultSource::View') )
    {
              ...
              grep {
                $question->schema->source($_)->result_class eq $dep
                  && !( $question->schema->source($_)
                    ->isa('DBIx::Class2::ResultSource::Table') )
...
SQL::Translator::Parser::DBIx::Class2 - Create a SQL::Translator schema
from a DBIx::Class2::Schema instance
...
C<SQL::Translator::Parser::DBIx::Class2> reads a DBIx::Class2 schema,
interrogates the columns, and stuffs it all in an $sqlt_schema object.

Its primary use is in deploying database layouts described as a set
of L<DBIx::Class2> classes, to a database. To do this, see
L<DBIx::Class2::Schema/deploy>.

This can also be achieved by having DBIx::Class2 export the schema as a
...
L<DBIx::Class2::Schema/create_ddl_dir>.

=head1 PARSER OPTIONS

=head2 dbic_schema

The DBIx::Class2 schema (either an instance or a class name) to be parsed.
...
L<SQL::Translator>, L<DBIx::Class2::Schema>
