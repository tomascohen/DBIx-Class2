package SQL::Translator::Producer::DBIx::Class2::File;

=head1 NAME

SQL::Translator::Producer::DBIx::Class2::File - DBIx::Class2 file producer
...
=head1 SYNOPSIS
  ...
  my $t = SQL::Translator->new( parser => '...',
                                producer => 'DBIx::Class2::File' );
  print $translator->translate( $file );

=head1 DESCRIPTION

Creates a DBIx::Class2::Schema for use with DBIx::Class2
